...
1. Install the custom integration using HACS or manually:
    * **Using HACS**: In the [HACS](https://hacs.xyz) panel, search for 'HAppy Irrigation' and install the integration.
...
3. Go to Configuration -> Integrations and add an integration. Search for 'HAppy Irrigation' and click to add it.
