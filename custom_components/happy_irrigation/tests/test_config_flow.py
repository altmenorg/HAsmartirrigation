...
from custom_components.happy_irrigation.config_flow import CannotConnect, InvalidAuth
...
class TestSmartIrrigationConfigFlow:
    ...
    @patch("custom_components.happy_irrigation.helpers.validate_api_key")
    ...
    @patch("custom_components.happy_irrigation.async_setup_entry", return_value=True)
