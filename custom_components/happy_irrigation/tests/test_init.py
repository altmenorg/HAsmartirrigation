"""Test HAppy Irrigation integration initialization."""
...
from custom_components.happy_irrigation import (
...
class TestSmartIrrigationIntegration:
    """Test HAppy Irrigation integration setup and teardown."""
    ...
    async def test_async_setup_entry_success(
        ...
        with (
            patch(
                "custom_components.happy_irrigation.async_get_registry"
            ) as mock_registry,
            patch(
                "custom_components.happy_irrigation.async_register_panel"
            ) as mock_panel,
            patch(
                "custom_components.happy_irrigation.async_register_websockets"
            ) as mock_ws,
            patch(
                "custom_components.happy_irrigation.register_services"
            ) as mock_services,
        ):
    ...
    async def test_async_setup_entry_with_weather_service(
        ...
        with (
            ...
            patch("custom_components.happy_irrigation.async_register_panel"),
            patch("custom_components.happy_irrigation.async_register_websockets"),
            patch("custom_components.happy_irrigation.register_services"),
        ):
            mock_store = AsyncMock()
            mock_store.async_get_config.return_value = {
    ...
    async def test_async_unload_entry(
        ...
        with patch(
            "custom_components.happy_irrigation.remove_panel"
...
class TestSmartIrrigationCoordinator:
    ...
    async def test_unit_system_change_handler(
        ...
        from custom_components.happy_irrigation import handle_core_config_change
    ...
    async def test_async_handle_unit_system_change(
        ...
        with (
            patch(
                "custom_components.happy_irrigation.async_dispatcher_send"
            ) as mock_dispatch,
            patch.object(
