...
from custom_components.happy_irrigation.panel import async_register_panel, remove_panel
...
class TestSmartIrrigationPanel:
    ...
    async def test_async_register_panel(self, mock_hass):
        ...
        with patch(
            "custom_components.happy_irrigation.panel.panel_custom.async_register_panel"
        ) as mock_register:
    ...
    def test_remove_panel(self, mock_hass):
        """Test panel removal."""
        with patch(
            "custom_components.happy_irrigation.panel.frontend.async_remove_panel"
        ) as mock_remove:
