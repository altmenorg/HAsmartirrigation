...
`;let Zn=class extends he{async showDialog(e){var t,a,i,n,s,r,o,l,d;if(this.params=e,e.createTrigger)this._trigger={type:Te,name:"",enabled:!0,offset_minutes:0,azimuth_angle:90,account_for_duration:!0};else if(e.trigger){const u=e.trigger;this._trigger=u.type===Me?{type:u.type,name:null!==(t=u.name)&&void 0!==t?t:"",enabled:null===(a=u.enabled)||void 0===a||a,offset_minutes:null!==(i=u.offset_minutes)&&void 0!==i?i:0,azimuth_angle:null!==(n=u.azimuth_angle)&&void 0!==n?n:90,account_for_duration:null===(s=u.account_for_duration)||void 0===s||s}:{type:u.type,name:null!==(r=u.name)&&void 0!==r?r:"",enabled:null===(o=u.enabled)||void 0===o||o,offset_minutes:null!==(l=u.offset_minutes)&&void 0!==l?l:0,account_for_duration:null===(d=u.account_for_duration)||void 0===d||d}}else this._trigger=void 0;await this.updateComplete}_closeDialog(){this.params=void 0,this._trigger=void 0}_saveTrigger(){var e,t,a,i,s;if(!this._trigger||!this.params)return;const r=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-select");if(r){const e=null!==(a=null!==(t=r.value)&&void 0!==t?t:r.selected)&&void 0!==a?a:void 0;if(e&&e!==this._trigger.type){if(e===Me)this._trigger=Object.assign(Object.assign({},this._trigger),{type:e,azimuth_angle:null!==(i=this._trigger.azimuth_angle)&&void 0!==i?i:90});else{const t=n(this._trigger,["azimuth_angle"]);this._trigger=Object.assign(Object.assign({},t),{type:e})}this.requestUpdate()}}if(null===(s=this._trigger.name)||void 0===s?void 0:s.trim()){if(this._trigger.type===Me){if(void 0===this._trigger.azimuth_angle||isNaN(this._trigger.azimuth_angle))return void alert(Nn("irrigation_start_triggers.validation.azimuth_invalid",this.hass.language));this._trigger.azimuth_angle=this._trigger.azimuth_angle%360,this._trigger.azimuth_angle<0&&(this._trigger.azimuth_angle+=360)}this.dispatchEvent(new CustomEvent("trigger-save",{detail:{trigger:this._trigger,isNew:this.params.createTrigger,index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog()}else alert(Nn("irrigation_start_triggers.validation.name_required",this.hass.language))}_deleteTrigger(){this.params&&!this.params.createTrigger&&(this.dispatchEvent(new CustomEvent("trigger-delete",{detail:{index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog())}_updateTrigger(e){this._trigger?(this._trigger=Object.assign(Object.assign({},this._trigger),e),this.requestUpdate()):console.warn("_updateTrigger called with undefined _trigger",e)}render(){var e,t;if(!this.params||!this._trigger)return V``;const a=this.params.createTrigger,i=Nn(a?"irrigation_start_triggers.dialog.add_title":"irrigation_start_triggers.dialog.edit_title",this.hass.language);return V`
      <ha-dialog open .heading=${!0}>
        ...
        <div class="wrapper">
          <div class="dialog-help">
            ${Nn("irrigation_start_triggers.dialog.help",this.hass.language)}
            <code>happy_irrigation_start_irrigation_all_zones</code>
          </div>
          <div class="form-group">
            <label class="form-label"
              >${Nn("irrigation_start_triggers.fields.name.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="text"
          ...
          <div class="form-group">
            <ha-select
              .label=${Nn("irrigation_start_triggers.fields.type.name",this.hass.language)}
              .value=${this._trigger.type}
              @selected=${this._typeChanged}
            >
              <ha-dropdown-item value=${Te}>
                ${Nn("irrigation_start_triggers.trigger_types.sunrise",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${"sunset"}>
                ${Nn("irrigation_start_triggers.trigger_types.sunset",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${Me}>
                ${Nn("irrigation_start_triggers.trigger_types.solar_azimuth",this.hass.language)}
              </ha-dropdown-item>
            </ha-select>
          </div>
          ...
          <div class="form-group">
            <ha-formfield
              .label=${Nn("irrigation_start_triggers.fields.enabled.name",this.hass.language)}
            >
              <ha-switch
          ...
          <div class="form-group">
            <label class="form-label"
              >${Nn("irrigation_start_triggers.fields.offset_minutes.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="number"
          ...
          <div class="form-group">
            <ha-formfield
              .label=${Nn("irrigation_start_triggers.fields.account_for_duration.name",this.hass.language)}
            >
              <ha-switch
          ...
          ${this._trigger.type===Me?V`
                <div class="form-group">
                  <label class="form-label"
                    >${Nn("irrigation_start_triggers.fields.azimuth_angle.name",this.hass.language)}</label
                  >
                  <input
                    class="form-input"
                    type="number"
    ...
    `}_nameChanged(e){const t=e.target;this._updateTrigger({name:t.value})}_typeChanged(e){var t,a,i,n,s,r,o,l,d,u,c,h,p,g,m,f,v,b,_,y,w,x,k,$;const S=null!==(n=null!==(a=null===(t=null==e?void 0:e.detail)||void 0===t?void 0:t.value)&&void 0!==a?a:null===(i=e.target)||void 0===i?void 0:i.value)&&void 0!==n?n:null===(r=null===(s=this.shadowRoot)||void 0===s?void 0:s.querySelector("ha-select"))||void 0===r?void 0:r.value,z=String(S);let A;A=z===Me?{type:Me,name:null!==(l=null===(o=this._trigger)||void 0===o?void 0:o.name)&&void 0!==l?l:"",enabled:null===(u=null===(d=this._trigger)||void 0===d?void 0:d.enabled)||void 0===u||u,offset_minutes:null!==(h=null===(c=this._trigger)||void 0===c?void 0:c.offset_minutes)&&void 0!==h?h:0,azimuth_angle:null!==(g=null===(p=this._trigger)||void 0===p?void 0:p.azimuth_angle)&&void 0!==g?g:90,account_for_duration:null===(f=null===(m=this._trigger)||void 0===m?void 0:m.account_for_duration)||void 0===f||f}:{type:z,name:null!==(b=null===(v=this._trigger)||void 0===v?void 0:v.name)&&void 0!==b?b:"",enabled:null===(y=null===(_=this._trigger)||void 0===_?void 0:_.enabled)||void 0===y||y,offset_minutes:null!==(x=null===(w=this._trigger)||void 0===w?void 0:w.offset_minutes)&&void 0!==x?x:0,account_for_duration:null===($=null===(k=this._trigger)||void 0===k?void 0:k.account_for_duration)||void 0===$||$},this._trigger=A,this.requestUpdate()}_enabledChanged(e){const t=e.target;this._updateTrigger({enabled:t.checked})}_offsetChanged(e){const t=e.target;this._updateTrigger({offset_minutes:parseInt(t.value)||0})}_accountForDurationChanged(e){const t=e.target;this._updateTrigger({account_for_duration:t.checked})}_azimuthChanged(e){var t;if((null===(t=this._trigger)||void 0===t?void 0:t.type)!==Me)return;const a=e.target;let i=parseInt(a.value,10);isNaN(i)&&(i=90),this._updateTrigger({azimuth_angle:i})}static get styles(){return[qn,h`
        .wrapper {
          color: var(--primary-text-color);
        }
      ...
      `]}};s([fe({attribute:!1})],Zn.prototype,"hass",void 0),s([fe({attribute:!1})],Zn.prototype,"params",void 0),s([ve()],Zn.prototype,"_trigger",void 0),Zn=s([ge("happy-irrigation-trigger-dialog")],Zn);const Kn=h`
...
`;let Xn=class extends(Ot(he)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(t),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ze+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{this.config=await Et(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}var e,t}}firstUpdated(){xe().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,t,a;if(!this.hass||!this.config||!this.data)return V`<div class="loading-indicator">
        ...
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Nn("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._timeRow(Nn("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language),this.config.calctime,(e=>this.handleConfigChange({calctime:e})))}
          </div>`),e=V`<ha-card
      ...
      >`;let t=V` <div class="card-content">
        ...
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Nn("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            <div class="setting-row">
              <div class="setting-label">
                ${Nn("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
              </div>
          ...
          <div class="card-content">
            ${this._numRow(Nn("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language),"s",this.config.autoupdatedelay,(e=>this.saveData({autoupdatedelay:parseInt(e)})),1)}
          </div>`),t=V`<ha-card header="${Nn("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`;let i=V` <div class="card-content">
        ...
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Nn("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._timeRow(Nn("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language),this.config.cleardatatime,(e=>this.handleConfigChange({cleardatatime:e})))}
          </div>`),i=V`<ha-card
      ...
      >`;let n=V`<div class="card-content">
        ...
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Nn("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._numRow(Nn("panels.general.cards.continuousupdates.labels.sensor_debounce",this.hass.language),"ms",this.config.sensor_debounce,(e=>this.handleConfigChange({sensor_debounce:parseInt(e)})),1)}
          </div>`),n=V`<ha-card
        header="${Nn("panels.general.cards.continuousupdates.header",this.hass.language)}"
        >${n}</ha-card
      > `;const s=this.renderTriggersCard(),r=this.renderWeatherSkipCard(),o=this.renderCoordinateCard(),l=this.renderDaysBetweenIrrigationCard();return V`<ha-card
          header="${Nn("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Nn("panels.general.description",this.hass.language)}
          </div> </ha-card
        >${t}${e}${i}${n}${s}${r}${o}${l}`}}renderTriggersCard(){if(!this.config||!this.data||!this.hass)return V``;const e=this.config.irrigation_start_triggers||[];return V`
      <ha-card
      ...
      >
        ...
        <div class="card-content trigger-usage">
          ${Nn("irrigation_start_triggers.usage_before",this.hass.language)}
          <code>happy_irrigation_start_irrigation_all_zones</code>${Nn("irrigation_start_triggers.usage_after",this.hass.language)}
        </div>
        ...
        <div class="card-content">
          ...
          <div class="add-trigger-section">
            ${this._actionBtn(Yn,Nn("irrigation_start_triggers.add_trigger",this.hass.language),(()=>this._addTrigger()))}
          </div>
        </div>
      </ha-card>
    `}renderTriggerItem(e,t){if(!this.hass)return V``;const a=Nn(`irrigation_start_triggers.trigger_types.${e.type}`,this.hass.language);let i="";if(e.type===Te&&0===e.offset_minutes)i=Nn("irrigation_start_triggers.offset_auto",this.hass.language);else{const t=Math.abs(e.offset_minutes),a=Math.floor(t/60),n=t%60,s=e.offset_minutes<0?Nn("common.labels.before",this.hass.language):Nn("common.labels.after",this.hass.language);i=a>0?`${a}h ${n}m ${s}`:`${n}m ${s}`}let n="";return e.type===Me&&void 0!==e.azimuth_angle&&(n=` (${e.azimuth_angle}°)`),V`
    ...
    `}_addTrigger(){this._showTriggerDialog({createTrigger:!0})}_editTrigger(e){var t,a;const i=null===(a=null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||void 0===a?void 0:a[e];i&&this._showTriggerDialog({trigger:i,triggerIndex:e})}_deleteTrigger(e){var t,a;if(!(null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||!this.hass)return;const i=(null===(a=this.config.irrigation_start_triggers[e])||void 0===a?void 0:a.name)||"Unknown";if(confirm(Nn("irrigation_start_triggers.confirm_delete",this.hass.language).replace("{name}",i))){const t=[...this.config.irrigation_start_triggers];t.splice(e,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[Ee]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}}async _showTriggerDialog(e){if(!this.hass)return;const t=document.createElement("happy-irrigation-trigger-dialog");t.hass=this.hass,t.addEventListener("trigger-save",(e=>{this._handleTriggerSave(e.detail)})),t.addEventListener("trigger-delete",(e=>{this._handleTriggerDelete(e.detail)})),document.body.appendChild(t),await t.showDialog(e),t.addEventListener("closed",(e=>{const a=e.target;a&&"ha-dialog"===a.tagName.toLowerCase()&&document.body.removeChild(t)}))}_handleTriggerSave(e){if(!this.config)return;const t=this.config.irrigation_start_triggers?[...this.config.irrigation_start_triggers]:[];e.isNew?t.push(e.trigger):void 0!==e.index&&(t[e.index]=e.trigger),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[Ee]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}_handleTriggerDelete(e){var t;if(!(null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||void 0===e.index)return;const a=[...this.config.irrigation_start_triggers];a.splice(e.index,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[Ee]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}renderWeatherSkipCard(){return this.config&&this.data&&this.hass?V`
      <ha-card header="${Nn("weather_skip.title",this.hass.language)}">
        ...
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Nn("weather_skip.title",this.hass.language)}
            </div>
            <ha-switch
          ...
          ${this.config.skip_irrigation_on_precipitation?this._numRow(Nn("weather_skip.threshold_label",this.hass.language),St(this.config,Ae),this.config.precipitation_threshold_mm,(e=>this.handleConfigChange({precipitation_threshold_mm:parseFloat(e)})),.1):""}
        </div>
      </ha-card>
    `:V``}renderCoordinateCard(){if(!this.config||!this.data||!this.hass)return V``;const e=this.hass.config,t=(null==e?void 0:e.latitude)||0,a=(null==e?void 0:e.longitude)||0,i=(null==e?void 0:e.elevation)||0;return V`
      ...
      >
        ...
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Nn("coordinate_config.manual_enabled",this.hass.language)}
            </div>
            <ha-switch
            ...
            ${this.data.manual_coordinates_enabled?V`
                    ${this._numRow(Nn("coordinate_config.latitude",this.hass.language),"",this.data.manual_latitude||t,(e=>this.handleConfigChange({manual_latitude:parseFloat(e)})),.1)}
                    ${this._numRow(Nn("coordinate_config.longitude",this.hass.language),"",this.data.manual_longitude||a,(e=>this.handleConfigChange({manual_longitude:parseFloat(e)})),.1)}
                    ${this._numRow(Nn("coordinate_config.elevation",this.hass.language),"",this.data.manual_elevation||i,(e=>this.handleConfigChange({manual_elevation:parseFloat(e)})),1)}
                  `:V`
                    <div
                      class="zoneline"
    ...
    `}renderDaysBetweenIrrigationCard(){return this.config&&this.data&&this.hass?V`
      ...
      >
        ...
        <div class="card-content">
          ${this._numRow(Nn("days_between_irrigation.label",this.hass.language),"",this.config.days_between_irrigation||0,(e=>this.handleConfigChange({days_between_irrigation:parseInt(e)})),1)}
          <div class="card-content">
            <div
    ...
    `}_numRow(e,t,a,i,n=1,s=!1){const r=(String(n).split(".")[1]||"").length,o=(e,t)=>{const a=parseFloat(e.value),s=+((isNaN(a)?0:a)+t*n).toFixed(r);e.value=String(s),i(String(s))};return V`
      <div class="setting-row">
        <div class="setting-label">
          ${e}${t?V` <span class="unit">(${t})</span>`:""}
        </div>
    ...
    `}static get styles(){return h`
      ${Gn} ${Kn} /* View-specific styles only - most common styles are now in globalStyle */
...
i.version="2.30.1",n(qa),i.fn=ls,i.min=Ja,i.max=Qa,i.now=ei,i.utc=g,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ga,i.invalid=b,i.duration=Ai,i.isMoment=k,i.weekdays=_s,i.parseZone=cs,i.localeData=va,i.isDuration=ri,i.monthsShort=bs,i.weekdaysMin=ws,i.defineLocale=ma,i.updateLocale=fa,i.locales=ba,i.weekdaysShort=ys,i.normalizeUnits=ae,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Ii,i.prototype=ls,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i}()}(hs)),hs.exports),gs=ds(ps);let ms=class extends(Ot(he)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){xe().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ze+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,t,a,i]=await Promise.all([Et(this.hass),Tt(this.hass),Mt(this.hass),Dt(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ze+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ze+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ze+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ze+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:ls.Automatic,duration:0,bucket:0,module:void 0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,t){this.hass&&(this.zones[e]=t,t.id&&this.zoneCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(t).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;if(!this.zones[t]||null==a)return;const i=[...this.zones];var n,s;this.zones=this.zones.filter(((e,a)=>a!==t)),this.zoneCache.delete(a.toString()),this.isSaving=!0,(n=this.hass,s=a.toString(),n.callApi("POST",ze+"/zones",{id:s,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",ze+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",ze+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var t;const a=this.zones[e];if(!a||null==a.mapping)return;const i=`#weather-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var t;const a=this.zones[e];if(!a||null==a.id)return;const i=`#calendar-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const t=await Ct(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,t)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const a of this.zones)if(void 0!==a.id)try{const i=await(e=this.hass,t=a.id.toString(),e.callWS({type:ze+"/watering_calendar",zone_id:t}));this.wateringCalendars.set(a.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${a.id}:`,e)}var e,t;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return V``;const t=this.weatherRecords.get(e.id)||[];return V`
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return V``;const t=this.wateringCalendars.get(e.id),a=t&&e.id in t?t[e.id]:null,i=(null==a?void 0:a.monthly_estimates)||[];return V` <div class="watering-calendar">
      ...
      <ha-card class="zone-card">
        ...
        ${d?V` <div class="zone-body">
              <div class="zone-meta">
                <div class="meta-item">
                  <span class="meta-label"
                    >${Nn("panels.zones.labels.last_calculated",i)}</span
                  >
                  <span class="meta-value"
                    >${e.last_calculated?gs(e.last_calculated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                    >${Nn("panels.zones.labels.data-last-updated",i)}</span
                  >
                  <span class="meta-value"
                    >${e.last_updated?gs(e.last_updated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                    >${Nn("panels.zones.labels.data-number-of-data-points",i)}</span
                  >
                  <span class="meta-value"
              ...
              <div class="settings">
                ${this._textRow(Nn("panels.zones.labels.name",i),"",e.name,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[rt]:a}))))}
                ${this._numRow(Nn("panels.zones.labels.size",i),St(this.config,ot),e.size,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ot]:parseFloat(a)}))),.1)}
                ${this._numRow(Nn("panels.zones.labels.throughput",i),St(this.config,lt),e.throughput,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[lt]:parseFloat(a)}))),.1)}
                ${this._numRow(Nn("panels.zones.labels.drainage_rate",i),St(this.config,bt),e.drainage_rate,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[bt]:parseFloat(a)}))),.1)}
                ${this._selectRow(Nn("panels.zones.labels.state",i),V`
                    <option
                      value="${ls.Automatic}"
                      ?selected=${e.state===ls.Automatic}
                    >
                      ${Nn("panels.zones.labels.states.automatic",i)}
                    </option>
                    <option
                      value="${ls.Disabled}"
                      ?selected=${e.state===ls.Disabled}
                    >
                      ${Nn("panels.zones.labels.states.disabled",i)}
                    </option>
                    <option
                      value="${ls.Manual}"
                      ?selected=${e.state===ls.Manual}
                    >
                      ${Nn("panels.zones.labels.states.manual",i)}
                    </option>
                  `,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[dt]:a.target.value,[ut]:0}))))}
                ${this._selectRow(Nn("common.labels.module",i),this.renderTheOptions(this.modules,e.module),(a=>{const i=a.target.value;this.handleEditZone(t,Object.assign(Object.assign({},e),{[ct]:""===i?void 0:parseInt(i)}))}))}
                ${this._selectRow(Nn("panels.zones.labels.mapping",i),this.renderTheOptions(this.mappings,e.mapping),(a=>{const i=a.target.value;this.handleEditZone(t,Object.assign(Object.assign({},e),{[gt]:""===i?void 0:parseInt(i)}))}))}
                ${this._numRow(Nn("panels.zones.labels.bucket",i),St(this.config,ht),Number(e.bucket).toFixed(1),(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ht]:parseFloat(a)}))),.1)}
                ${this._numRow(Nn("panels.zones.labels.maximum-bucket",i),St(this.config,ht),Number(e.maximum_bucket).toFixed(1),(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[vt]:parseFloat(a)}))),.1)}
                ${this._numRow(Nn("panels.zones.labels.lead-time",i),"s",e.lead_time,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[mt]:parseInt(a,10)}))),1)}
                ${this._numRow(Nn("panels.zones.labels.maximum-duration",i),"s",e.maximum_duration,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ft]:parseInt(a,10)}))),1)}
                ${this._numRow(Nn("panels.zones.labels.multiplier",i),"",e.multiplier,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[pt]:parseFloat(a)}))),.1)}
                ${this._numRow(Nn("panels.zones.labels.duration",i),"s",e.duration,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ut]:parseInt(a,10)}))),1,s)}
              </div>

              <div class="zone-actions">
                ${n?V`
                      ${this._actionBtn(Pn,Nn("panels.zones.actions.calculate",i),(()=>this.handleCalculateZone(t)))}
                      ${this._actionBtn(Vn,Nn("panels.zones.actions.update",i),(()=>this.handleUpdateZone(t)))}
                    `:""}
                ${this._actionBtn(Fn,Nn("panels.zones.actions.reset-bucket",i),(()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ht]:0}))))}
                ${null!=e.mapping?this._actionBtn(Rn,Nn("panels.zones.actions.view-weather-info",i),(()=>this.handleViewWeatherInfo(t))):""}
                ${this._actionBtn("M19,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z",Nn("panels.zones.actions.view-watering-calendar",i),(()=>this.handleViewWateringCalendar(t)))}
                ${r?this._actionBtn("M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z",Nn("panels.zones.actions.information",i),(()=>this.toggleExplanation(t))):""}
                ${this._actionBtn(In,Nn("common.actions.delete",i),(e=>this.handleRemoveZone(e,t)),!0)}
              </div>

              ${r?V`<label class="hidden" id="calcresults${t}"
                    >${kt("<br/>"+e.explanation)}</label
                  >`:""}
    ...
    `}toggleExplanation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#calcresults"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="explanation")}render(){return this.hass?this.isLoading?V`
      ...
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Nn("panels.zones.labels.name",this.hass.language)}
            </div>
            <input
              id="nameInput"
              class="field"
          ...
          <div class="add-zone-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Yn}></ha-svg-icon>
      ...
      ${rs(this.zones,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderZone(e,t)))}
      ...
      >
        <div class="card-content">
          <div class="zone-actions-grid">
            ${this._actionBtn(Pn,Nn("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language),(()=>this.handleCalculateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Vn,Nn("panels.zones.cards.zone-actions.actions.update-all",this.hass.language),(()=>this.handleUpdateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Fn,Nn("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),(()=>this.handleResetAllBuckets()),!1,this.isSaving)}
            ${this._actionBtn(Rn,Nn("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),(()=>this.handleClearAllWeatherdata()),!1,this.isSaving)}
          </div>
        </div>
      </ha-card>
    ...
    `}};s([fe()],ms.prototype,"config",void 0),s([fe({type:Array})],ms.prototype,"zones",void 0),s([fe({type:Array})],ms.prototype,"modules",void 0),s([fe({type:Array})],ms.prototype,"mappings",void 0),s([fe({type:Map})],ms.prototype,"wateringCalendars",void 0),s([fe({type:Map})],ms.prototype,"weatherRecords",void 0),s([fe({type:Boolean})],ms.prototype,"isLoading",void 0),s([fe({type:Boolean})],ms.prototype,"isSaving",void 0),s([fe({type:Boolean})],ms.prototype,"isCreatingZone",void 0),s([be("#nameInput")],ms.prototype,"nameInput",void 0),s([be("#sizeInput")],ms.prototype,"sizeInput",void 0),s([be("#throughputInput")],ms.prototype,"throughputInput",void 0),ms=s([ge("happy-irrigation-view-zones")],ms);let fs=class extends(Ot(he)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map,this._expanded=new Set,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this._suppressNextConfigUpdate=!0,this.saveToHA(t).catch((()=>{this._suppressNextConfigUpdate=!1})),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleItem(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){xe().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ze+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{const[t,a,i,n]=await Promise.all([Et(this.hass),Tt(this.hass),Mt(this.hass),(e=this.hass,e.callWS({type:ze+"/allmodules"}))]);this.config=t,this.zones=a,this.modules=i,this.allmodules=n,this.moduleCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}var e}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find((t=>t.name===e));if(!t)return;const a={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,a],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(a),await this._fetchData()}catch(e){console.error("Error adding module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],n=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter(((e,a)=>a!==t)),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==n&&await(a=this.hass,i=n.toString(),a.callApi("POST",ze+"/modules",{id:i,remove:!0}))}catch(e){console.error("Error removing module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var a,i}}async saveToHA(e){var t,a;if(this.hass)try{await(t=this.hass,a=e,t.callApi("POST",ze+"/modules",a))}catch(e){throw console.error("Error saving module:",e),e}}renderModule(e,t){var a,i;if(!this.hass)return V``;const n=this.zones.filter((t=>t.module===e.id)).length,s=null!==(a=e.id)&&void 0!==a?a:t,r=this._expanded.has(s),o=e.description||(null===(i=this.allmodules.find((t=>t.name===e.name)))||void 0===i?void 0:i.description)||"",l=`module-${e.id||t}-${r?"open":"closed"}-${JSON.stringify(e)}`;if(this.moduleCache.has(l))return this.moduleCache.get(l);const d=V`
    ...
    `;return this.moduleCache.set(l,d),d}renderConfig(e,t){const a=Object.values(this.modules).at(e);if(!a||!this.hass)return;const i=a.schema[t],n=i.name,s=function(e){if(e)return(e=e.replace("_"," ")).charAt(0).toUpperCase()+e.slice(1)}(n);let r="";null==a.config&&(a.config=[]),n in a.config&&(r=a.config[n]);const o=i.required?`${s} *`:null!=s?s:"";if("boolean"==i.type)return V`
      ...
      `;if("float"==i.type||"integer"==i.type)return this._numRow(o,"",a.config[n],(t=>this.handleEditConfig(e,Object.assign(Object.assign({},a),{config:Object.assign(Object.assign({},a.config),{[n]:t})}))),1);if("string"==i.type)return this._textRow(o,"",r,(t=>this.handleEditConfig(e,Object.assign(Object.assign({},a),{config:Object.assign(Object.assign({},a.config),{[n]:t})}))));if("select"==i.type){const t=this.hass.language,s=V`
        ${Object.entries(i.options).map((([e,a])=>V`<option
              value="${$t(a,0)}"
              ?selected="${r===$t(a,0)}"
            >
              ${Nn("panels.modules.cards.module.translated-options."+$t(a,1),t)}
            </option>`))}
      `;return this._selectRow(o,s,(t=>this.handleEditConfig(e,Object.assign(Object.assign({},a),{config:Object.assign(Object.assign({},a.config),{[n]:t.target.value})}))))}return V``}_textRow(e,t,a,i){return V`
      <div class="setting-row">
        <div class="setting-label">
          ${e}${t?V` <span class="unit">(${t})</span>`:""}
        </div>
    ...
    `}handleEditConfig(e,t){this.modules=Object.values(this.modules).map(((a,i)=>i===e?t:a)),this.moduleCache.clear(),this._scheduleUpdate(),this.debouncedSave(t)}renderOption(e,t){return this.hass?V`<option value="${e}>${t}</option>`:V``}render(){return this.hass?V`
      ...
      >
        <div class="card-content">
          ${this.isLoading?V`<div class="loading-indicator">
                ...
                <div class="setting-row">
                  <div class="setting-label">
                    ${Nn("common.labels.module",this.hass.language)}
                  </div>
                  <div class="select-wrap">
                    <select
                      id="moduleInput"
      ...
      ${this.isLoading?V`<div class="loading-indicator">
          ...
          </div>`:rs(this.modules,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderModule(e,t)))}
        ...
        ${0===t.length?V`
            ...
            `:V`
              <div class="weather-table">
                ...
                ${t.slice(0,10).map((e=>{let t="-",a="-";try{if(e.timestamp&&null!==e.timestamp){const a=gs(e.timestamp);a.isValid()&&(t=a.format("MM-DD HH:mm"))}}catch(t){console.warn("Error formatting timestamp:",e.timestamp,t)}try{if(e.retrieval_time&&null!==e.retrieval_time){const t=gs(e.retrieval_time);t.isValid()&&(a=t.format("MM-DD HH:mm"))}}catch(t){console.warn("Error formatting retrieval_time:",e.retrieval_time,t)}return V`
                    <div class="weather-row">
                      <span>${t}</span>
                      <span
    ...
    `;return this.mappingCache.set(a,n),n}renderMappingSetting(e,t){const a=this.mappings[e];if(!a||!this.hass)return V``;const i=a.mappings[t];return V`
      <div class="si-subgroup">
        ...
        ${this._selectRow(Nn("panels.mappings.cards.mapping.source",this.hass.language),this.renderSimpleRadioOptions(e,t,i),(a=>this.handleSimpleSourceChange(e,t,a)))}
        ${this.renderMappingInputs(e,t,i)}
      </div>
    `}renderSimpleRadioOptions(e,t,a){if(!this.hass||!this.config)return V``;const i=t===Le||t===Be,n=a[Je];return V`
    ...
    `}renderWeatherServiceOption(e,t,a){if(!this.hass||!this.config)return V``;const i=`${t}_${e}`,n=!this.config.use_weather_service,s=this.config.use_weather_service&&a[Je]===Ve;return V`
    ...
    `}renderNoneOption(e,t,a){if(!this.hass)return V``;const i=`${t}_${e}`,n=a[Je]===Xe;return V`
      <label>
        <input
          type="radio"
          id="${i}_none"
    ...
    `}renderSensorOption(e,t,a){if(!this.hass)return V``;const i=`${t}_${e}`,n=a[Je]===We;return V`
      <label>
        <input
          type="radio"
          id="${i}_sensor"
    ...
    `}renderStaticValueOption(e,t,a){if(!this.hass)return V``;const i=`${t}_${e}`,n=a[Je]===Ge;return V`
      <label>
        <input
          type="radio"
          id="${i}_static"
    ...
    `}handleSourceChange(e,t,a){const i=this.mappings[e],n=a.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Je]:n,[Qe]:""})})}))}renderMappingInputs(e,t,a){if(!this.hass)return V``;const i=a[Je];return V`
      ${i===We?this.renderSensorInput(e,t,a):""}
      ${i===Ge?this.renderStaticValueInput(e,t,a):""}
      ${i===We||i===Ge?this.renderUnitSelect(e,t,a):""}
      ${t!==Ue||i!==We&&i!==Ge?"":this.renderPressureTypeSelect(e,t,a)}
    ...
    `:V``}renderStaticValueInput(e,t,a){return this.hass?this._numRow(Nn("panels.mappings.cards.mapping.static_value",this.hass.language),"",a[et]||"",(a=>this.handleStaticValueChange(e,t,{target:{value:a}})),.1):V``}renderUnitSelect(e,t,a){return this.hass&&this.config?this._selectRow(Nn("panels.mappings.cards.mapping.input-units",this.hass.language),this.renderUnitOptionsForMapping(t,a),(a=>this.handleUnitChange(e,t,a))):V``}renderPressureTypeSelect(e,t,a){return this.hass?this._selectRow(Nn("panels.mappings.cards.mapping.pressure-type",this.hass.language),this.renderPressureTypes(t,a),(a=>this.handlePressureTypeChange(e,t,a))):V``}renderAggregateSelect(e,t,a){return this.hass?V`
      <div class="setting-row">
        <div class="setting-label">
          ${Nn("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          <span class="unit"
            >${Nn("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</span
          >
        </div>
        <div class="select-wrap">
          <select
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return V`<option value="${e}" ?selected="${e===t}">
        ...
        <option
          ...
          ?selected="${a===Ze}"
        >
          ${Nn("panels.mappings.cards.mapping.pressure_types."+Ze,this.hass.language)}
        </option>
        <option
          value="${Ke}"
          ?selected="${a===Ke}"
        >
          ${Nn("panels.mappings.cards.mapping.pressure_types."+Ke,this.hass.language)}
        </option>`,e}return V``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return V``;const a=function(e){switch(e){case Pe:case Fe:return[{unit:"°C",system:Ne},{unit:"°F",system:He}];case Re:case Le:return[{unit:"mm",system:Ne},{unit:"in",system:He}];case Ie:return[{unit:nt,system:Ne},{unit:st,system:He}];case je:return[{unit:"%",system:[Ne,He]}];case Ue:return[{unit:"millibar",system:Ne},{unit:"hPa",system:Ne},{unit:"psi",system:He},{unit:"inch Hg",system:He}];case Ye:return[{unit:"km/h",system:Ne},{unit:"meter/s",system:Ne},{unit:"mile/h",system:He}];case Be:return[{unit:"W/m2",system:Ne},{unit:"MJ/day/m2",system:Ne},{unit:"W/sq ft",system:He},{unit:"MJ/day/sq ft",system:He}];default:return[]}}(e);let i=t[tt];const n=this.config.units;if(!t[tt])for(const e of a)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const t of e.system)if(n===t.system){i=e.unit;break}if(i===e.unit)break}return V`
      ${a.map((e=>V`
    ...
    `}render(){return this.hass?this.isLoading?V`
      ...
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Nn("panels.mappings.labels.mapping-name",this.hass.language)}
            </div>
          ...
          <div class="si-form-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Yn}></ha-svg-icon>
              ${this.isSaving?Nn("common.saving-messages.adding",this.hass.language):Nn("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
    ...
    `:V``}renderMappingsList(){const e=this.mappings.slice(0,Math.min(this.mappings.length,10)),t=this.mappings.slice(10);return V`
      ${rs(e,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderMappingCard(e,t)))}
      ${t.length>0?V`
            <div class="si-form-actions">
              ${this._actionBtn(Yn,`Load ${t.length} more mappings...`,(()=>this.loadMoreMappings()))}
            </div>
          `:""}
    `}renderMappingCard(e,t){if(!this.hass)return V``;const a=this.hass.language,i=this.zones.filter((t=>t.mapping===e.id)).length,n=Object.keys(e.mappings||{}).length,s=[];s.push(`${n} ${Nn("panels.mappings.title",a).toLowerCase()}`),i&&s.push(`${i} ${Nn("panels.zones.title",a).toLowerCase()}`);const r=s.join(" · "),o=null!=e.id&&this._expanded.has(e.id);return V`
      <ha-card class="si-card">
        <div
          class="si-head"
          role="button"
        ...
        ${o?V`<div class="si-body">
              <div class="settings">
                ${this._textRow(Nn("panels.mappings.labels.mapping-name",a),"",e.name,(a=>this.handleEditMapping(t,Object.assign(Object.assign({},e),{name:a}))))}
                ${this.renderMappingSettings(e,t)}
              </div>
              ${this.renderWeatherRecords(e)}
              <div class="si-actions">
                ${i?V`<div class="weather-note">
                      ${Nn("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",a)}
                    </div>`:this._actionBtn(In,Nn("common.actions.delete",a),(e=>this.handleRemoveMapping(e,t)),!0)}
              </div>
            </div>`:""}
      </ha-card>
      ...
      <ha-card header="${Nn("panels.weatherservice.title",t)}">
        ...
        <div class="card-content">
          ...
          ${this._use?V`
                <div class="setting-row">
                  <div class="setting-label">
                    ${Nn("panels.weatherservice.labels.service",t)}
                  </div>
                  <div class="select-wrap">
                    <select
                      class="field"
                ...
                <div class="setting-row">
                  <div class="setting-label">
                    ${Nn("panels.weatherservice.labels.api-key",t)}
                  </div>
                  <input
                    class="field"
                    type="text"
          ...
          <div class="ws-actions">
            <ha-button
              ...
              @click=${this._save}
            >
              ${this._saving?Nn("panels.weatherservice.actions.saving",t):Nn("panels.weatherservice.actions.save",t)}
            </ha-button>
          </div>
          <div class="ws-note ws-reload-note">
            ${Nn("panels.weatherservice.messages.reload-note",t)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return h`
    ...
    `}};s([fe()],bs.prototype,"narrow",void 0),s([fe()],bs.prototype,"path",void 0),s([ve()],bs.prototype,"_info",void 0),s([ve()],bs.prototype,"_use",void 0),s([ve()],bs.prototype,"_service",void 0),s([ve()],bs.prototype,"_apiKey",void 0),s([ve()],bs.prototype,"_loading",void 0),s([ve()],bs.prototype,"_saving",void 0),s([ve()],bs.prototype,"_error",void 0),s([ve()],bs.prototype,"_saved",void 0),bs=s([ge("happy-irrigation-view-weatherservice")],bs);let _s=class extends he{constructor(){super(...arguments),this._busy=!1,this._error="",this._message="",this._pendingName=""}firstUpdated(){xe().catch((e=>{console.error("Failed to load HA form:",e)}))}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}_reset(){this._error="",this._message="",this._pending=void 0,this._pendingName=""}async _export(){if(this.hass){this._reset(),this._busy=!0;try{const t=await(e=this.hass,e.callApi("GET",ze+"/export")),a=JSON.stringify(t,null,2),i=new Blob([a],{type:"application/json"}),n=URL.createObjectURL(i),s=document.createElement("a");s.href=n;const r=(new Date).toISOString().slice(0,19).replace("T","_").replace(/:/g,"-");s.download=`happy_irrigation_backup_${r}.json`,s.click(),URL.revokeObjectURL(n),this._message=Nn("panels.backuprestore.messages.exported",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e}}async _onFile(e){this._reset();const t=e.target,a=t.files&&t.files[0];if(a)try{const e=await a.text(),t=JSON.parse(e);if(!t||"object"!=typeof t||!t.config)throw new Error(Nn("panels.backuprestore.messages.invalid-file",this.hass.language));this._pending=t,this._pendingName=a.name}catch(e){this._error=this._errText(e)}finally{t.value=""}}async _restore(){if(this.hass&&this._pending){this._busy=!0,this._error="",this._message="";try{const a=await(e=this.hass,t=this._pending,e.callApi("POST",ze+"/restore",t));if(a&&!1===a.success)throw new Error(a.error||"restore failed");this._pending=void 0,this._pendingName="",this._message=Nn("panels.backuprestore.messages.restored",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e,t}}_count(e){const t=this._pending&&this._pending[e];return Array.isArray(t)?t.length:0}render(){if(!this.hass)return V``;const e=this.hass.language;return V`
      <ha-card header="${Nn("panels.backuprestore.title",e)}">
        <div class="card-content br-description">
          ${Nn("panels.backuprestore.description",e)}
        </div>
      </ha-card>

      <ha-card
        header="${Nn("panels.backuprestore.cards.backup.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${Nn("panels.backuprestore.cards.backup.description",e)}
          </div>
          ...
          <div class="br-actions">
            ...
            >
              ...
              ${Nn("panels.backuprestore.actions.export",e)}
            </ha-button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${Nn("panels.backuprestore.cards.restore.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${Nn("panels.backuprestore.cards.restore.description",e)}
          </div>
          ...
          <label class="br-file">
            ...
            ${Nn("panels.backuprestore.actions.choose-file",e)}
          </label>
                ...
                <div class="br-warning">
                  ...
                  <div>
                    <div class="br-warning-title">
                      ${Nn("panels.backuprestore.messages.confirm-title",e)}
                    </div>
                    <div class="br-file-name">${this._pendingName}</div>
                    <div class="br-summary">
                      ${Nn("panels.backuprestore.messages.summary",e)}:
                      ${this._count("zones")}
                      ${Nn("panels.zones.title",e)} ·
                      ${this._count("modules")}
                      ${Nn("panels.modules.title",e)} ·
                      ${this._count("mappings")}
                      ${Nn("panels.mappings.title",e)}
                    </div>
                    <div class="br-warning-text">
                      ${Nn("panels.backuprestore.messages.confirm-warning",e)}
                    </div>
                  </div>
                </div>
              `:""}
          ...
          ${this._pending?V`<div class="br-actions">
                <ha-button
                  ...
                  @click=${this._restore}
                >
                  <ha-svg-icon slot="start" .path=${Wn}></ha-svg-icon>
                  ${this._busy?Nn("panels.backuprestore.actions.restoring",e):Nn("panels.backuprestore.actions.restore",e)}
                </ha-button>
              </div>`:""}
          <div class="br-note">
            ${Nn("panels.backuprestore.messages.reload-note",e)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return h`
    ...
    `}};s([fe()],_s.prototype,"narrow",void 0),s([fe()],_s.prototype,"path",void 0),s([ve()],_s.prototype,"_busy",void 0),s([ve()],_s.prototype,"_error",void 0),s([ve()],_s.prototype,"_message",void 0),s([ve()],_s.prototype,"_pending",void 0),s([ve()],_s.prototype,"_pendingName",void 0),_s=s([ge("happy-irrigation-view-backuprestore")],_s);let ys=class extends(Ot(he)){constructor(){super(...arguments),this.zones=[],this.isLoading=!0,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){xe().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ze+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[t,a,i]=await Promise.all([Et(this.hass),(e=this.hass,e.callWS({type:ze+"/info"})),Tt(this.hass)]);this.config=t,this.info=a,this.zones=i}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}render(){return this.hass?this.isLoading?V`
    ...
    `:V`
      ...
      >
        <div class="card-content">
          ${this.zones.map((t=>{var a,i,n,s,r,o,l,d;return V`
    ...
    `}renderNextIrrigationCard(){var e,t,a,i,n,s,r,o;return this.hass&&this.info?V`
      <ha-card
      ...
      >
        <div class="card-content">
          <div class="info-item">
            ...
            >
            <span class="value">
              ${this.info.next_irrigation_start?gs(this.info.next_irrigation_start).format("YYYY-MM-DD HH:mm:ss"):Nn("panels.info.cards.next-irrigation.no-data",this.hass.language)}
            </span>
          </div>
    ...
    `:V`
      ...
      `}renderIrrigationReasonCard(){var e,t,a,i,n,s,r,o;return this.hass&&this.info?V`
      <ha-card
        ...
        <div class="card-content">
          ...
          ${this.info.sunrise_time?V`
                <div class="info-item">
                  ...
                  >
                  <span class="value"
                    >${gs(this.info.sunrise_time).format("HH:mm:ss")}</span
                  >
                </div>
              `:""}
    ...
    `}};s([fe()],ys.prototype,"config",void 0),s([fe({type:Object})],ys.prototype,"info",void 0),s([fe({type:Array})],ys.prototype,"zones",void 0),s([fe({type:Boolean})],ys.prototype,"isLoading",void 0),ys=s([ge("happy-irrigation-view-info")],ys);const ws=Gn,xs=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a},ks=(e,...t)=>{let a={page:e,params:{}};t.forEach((e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}))}));const i=e=>{let t=Object.keys(e);t=t.filter((t=>e[t])),t.sort();let a="";return t.forEach((t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`})),a};let n=`/${ze}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n};var $s;!function(e){e.Info="info",e.General="general",e.Zones="zones",e.Modules="modules",e.Mappings="mappings",e.WeatherService="weatherservice",e.BackupRestore="backuprestore",e.Help="help"}($s||($s={})),e.SmartIrrigationPanel=class extends he{constructor(){super(...arguments),this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}async firstUpdated(){const e=xs();e.page&&Object.values($s).includes(e.page)?(window.addEventListener("location-changed",(()=>{if(!window.location.pathname.includes("happy_irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())})),xe().then((()=>{this._scheduleUpdate()})).catch((e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}))):At(0,ks($s.General))}render(){const e=xs(),t=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return V`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"info":return V`
        ...
        `}}navigateToPage(e){if(e!==xs().page){const t=ks(e);At(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==xs().page){const e=ks(t);At(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[ws,h`
        :host {
          color: var(--primary-text-color);
      ...
      `]}},s([fe({attribute:!1})],e.SmartIrrigationPanel.prototype,"hass",void 0),s([fe({type:Boolean,reflect:!0})],e.SmartIrrigationPanel.prototype,"narrow",void 0),e.SmartIrrigationPanel=s([ge("happy-irrigation")],e.SmartIrrigationPanel);let Ss=class extends he{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?V`
      <ha-dialog
        open
        .heading=${!0}
    ...
    `}};s([fe({attribute:!1})],Ss.prototype,"hass",void 0),s([ve()],Ss.prototype,"_params",void 0),Ss=s([ge("happy-irrigation-error-dialog")],Ss);var zs=Object.freeze({__proto__:null,get ErrorDialog(){return Ss}});Object.defineProperty(e,"__esModule",{value:!0})}({});
