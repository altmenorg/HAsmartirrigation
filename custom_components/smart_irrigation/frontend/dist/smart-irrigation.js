...
`,ml="06:00";let gl=class extends de{async showDialog(e){if(this.params=e,e.createTrigger)this._trigger={type:vr,name:"",enabled:!0,offset_minutes:0,azimuth_angle:90,account_for_duration:!0};else if(e.trigger){const t=e.trigger;this._trigger=function(e){var t,a,i,n,s,r;const o={type:e.type,name:null!==(t=e.name)&&void 0!==t?t:"",enabled:null===(a=e.enabled)||void 0===a||a,offset_minutes:null!==(i=e.offset_minutes)&&void 0!==i?i:0,account_for_duration:null===(n=e.account_for_duration)||void 0===n||n};return e.type===fr?Object.assign(Object.assign({},o),{azimuth_angle:null!==(s=e.azimuth_angle)&&void 0!==s?s:90}):e.type===br?Object.assign(Object.assign({},o),{at:null!==(r=e.at)&&void 0!==r?r:ml}):o}(t)}else this._trigger=void 0;await this.updateComplete}_closeDialog(){this.params=void 0,this._trigger=void 0}_saveTrigger(){var e,a,i,n,s,r,o;if(!this._trigger||!this.params)return;const l=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-select");if(l){const e=null!==(i=null!==(a=l.value)&&void 0!==a?a:l.selected)&&void 0!==i?i:void 0;if(e&&e!==this._trigger.type){if(e===fr)this._trigger=Object.assign(Object.assign({},this._trigger),{type:e,azimuth_angle:null!==(n=this._trigger.azimuth_angle)&&void 0!==n?n:90});else if(e===br){const a=this._trigger,{azimuth_angle:i}=a,n=t(a,["azimuth_angle"]);this._trigger=Object.assign(Object.assign({},n),{type:e,at:null!==(s=this._trigger.at)&&void 0!==s?s:ml})}else{const a=this._trigger,{azimuth_angle:i,at:n}=a,s=t(a,["azimuth_angle","at"]);this._trigger=Object.assign(Object.assign({},s),{type:e})}this.requestUpdate()}}if(null===(r=this._trigger.name)||void 0===r?void 0:r.trim())if(this._trigger.type!==br||/^\d{1,2}:\d{2}$/.test(null!==(o=this._trigger.at)&&void 0!==o?o:"")){if(this._trigger.type===fr){if(void 0===this._trigger.azimuth_angle||isNaN(this._trigger.azimuth_angle))return void alert(dr("irrigation_start_triggers.validation.azimuth_invalid",this.hass.language));this._trigger.azimuth_angle=this._trigger.azimuth_angle%360,this._trigger.azimuth_angle<0&&(this._trigger.azimuth_angle+=360)}this.dispatchEvent(new CustomEvent("trigger-save",{detail:{trigger:this._trigger,isNew:this.params.createTrigger,index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog()}else alert(dr("irrigation_start_triggers.validation.time_invalid",this.hass.language));else alert(dr("irrigation_start_triggers.validation.name_required",this.hass.language))}_deleteTrigger(){this.params&&!this.params.createTrigger&&(this.dispatchEvent(new CustomEvent("trigger-delete",{detail:{index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog())}_updateTrigger(e){this._trigger?(this._trigger=Object.assign(Object.assign({},this._trigger),e),this.requestUpdate()):console.warn("_updateTrigger called with undefined _trigger",e)}render(){var e,t;if(!this.params||!this._trigger)return q``;const a=this.params.createTrigger,i=dr(a?"irrigation_start_triggers.dialog.add_title":"irrigation_start_triggers.dialog.edit_title",this.hass.language);return q`
          ...
          ${this._trigger.type===br?q`
                <div class="form-group">
                  ...
                  <input
                    class="form-input"
                    type="time"
                    .value=${this._trigger.at||ml}
                    @input=${this._atChanged}
                  />
                </div>
              `:""}
          ${this._trigger.type===fr?q`
                <div class="form-group">
                  <label class="form-label"
    ...
    `}_nameChanged(e){const t=e.target;this._updateTrigger({name:t.value})}_typeChanged(e){var t,a,i,n,s,r,o,l,d,u,c,p,m,g,h,v,f,b,k,y,_,z,w,x;const S=null!==(n=null!==(a=null===(t=null==e?void 0:e.detail)||void 0===t?void 0:t.value)&&void 0!==a?a:null===(i=e.target)||void 0===i?void 0:i.value)&&void 0!==n?n:null===(r=null===(s=this.shadowRoot)||void 0===s?void 0:s.querySelector("ha-select"))||void 0===r?void 0:r.value,j=String(S);let A;A=j===fr?{type:fr,name:null!==(l=null===(o=this._trigger)||void 0===o?void 0:o.name)&&void 0!==l?l:"",enabled:null===(u=null===(d=this._trigger)||void 0===d?void 0:d.enabled)||void 0===u||u,offset_minutes:null!==(p=null===(c=this._trigger)||void 0===c?void 0:c.offset_minutes)&&void 0!==p?p:0,azimuth_angle:null!==(g=null===(m=this._trigger)||void 0===m?void 0:m.azimuth_angle)&&void 0!==g?g:90,account_for_duration:null===(v=null===(h=this._trigger)||void 0===h?void 0:h.account_for_duration)||void 0===v||v}:{type:j,name:null!==(b=null===(f=this._trigger)||void 0===f?void 0:f.name)&&void 0!==b?b:"",enabled:null===(y=null===(k=this._trigger)||void 0===k?void 0:k.enabled)||void 0===y||y,offset_minutes:null!==(z=null===(_=this._trigger)||void 0===_?void 0:_.offset_minutes)&&void 0!==z?z:0,account_for_duration:null===(x=null===(w=this._trigger)||void 0===w?void 0:w.account_for_duration)||void 0===x||x},this._trigger=A,this.requestUpdate()}_enabledChanged(e){const t=e.target;this._updateTrigger({enabled:t.checked})}_offsetChanged(e){const t=e.target;this._updateTrigger({offset_minutes:parseInt(t.value)||0})}_accountForDurationChanged(e){const t=e.target;this._updateTrigger({account_for_duration:t.checked})}_atChanged(e){const t=e.target.value;this._trigger=Object.assign(Object.assign({},this._trigger),{at:t})}_azimuthChanged(e){var t;if((null===(t=this._trigger)||void 0===t?void 0:t.type)!==fr)return;const a=e.target;let i=parseInt(a.value,10);isNaN(i)&&(i=90),this._updateTrigger({azimuth_angle:i})}static get styles(){return[pl,l`
      ...
      `]}};a([me({attribute:!1})],gl.prototype,"hass",void 0),a([me({attribute:!1})],gl.prototype,"params",void 0),a([ge()],gl.prototype,"_trigger",void 0),gl=a([ce("smart-irrigation-trigger-dialog")],gl);const hl=l`
...
`;let vl=class extends(Qo(de)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(t),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:mr+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{this.config=await qo(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","continuousupdates","sensor_debounce","calc_log_enabled","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}var e,t}}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,t,a;if(!this.hass||!this.config||!this.data)return q`<div class="loading-indicator">
      ...
      >
        ${e}</ha-card
      >`;let t=q` <div class="card-content">
        ...
        <div class="card-content">
        ...
        </div>`;this.data.autoupdateenabled&&(t=q`${t}
          <div class="card-content">
            <div class="setting-row">
              <div class="setting-label">
          ...
          </div>`),t=q`<ha-card header="${dr("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`;let i=q`<div class="card-content">
        ...
        </div>`;this.data.continuousupdates&&(i=q`${i}
          <div class="card-content">
        ...
        >${i}</ha-card
      > `;const n=this.renderTriggersCard(),s=this.renderWeatherSkipCard(),r=this.renderCoordinateCard(),o=this.renderDaysBetweenIrrigationCard(),l=this.renderObservedWateringCard(),d=this.renderCalculationLogCard();return q`<ha-card
          header="${dr("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${dr("panels.general.description",this.hass.language)}
          </div> </ha-card
        >${t}${e}${i}${n}${s}${r}${o}${l}${d}`}}renderTriggersCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.config.irrigation_start_triggers||[];return q`
      <ha-card
    ...
    `}renderCalculationLogCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.language;return q`
      <ha-card header="${dr("calculation_log.title",e)}">
        ...
        <div class="card-content">
          ...
          ${this.config.calc_log_enabled?q`<div
                class="zoneline"
    ...
    `}renderCoordinateCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.config,t=(null==e?void 0:e.latitude)||0,a=(null==e?void 0:e.longitude)||0,i=(null==e?void 0:e.elevation)||0;return q`
      <ha-card
    ...
    `:q``}async saveData(e){if(this.hass&&this.data){this.isSaving=!0,this._scheduleUpdate(),this._suppressNextConfigUpdate=!0;try{this.data=Object.assign(Object.assign({},this.data),e),this.config=Object.assign(Object.assign({},this.config),e),this._scheduleUpdate(),await(t=this.hass,a=this.data,t.callApi("POST",mr+"/config",a))}catch(e){this._suppressNextConfigUpdate=!1,console.error("Error saving config:",e),Co(e,this.shadowRoot.querySelector("ha-card")),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var t,a}}handleConfigChange(e){this.debouncedSave(e)}disconnectedCallback(){super.disconnectedCallback()}_textRow(e,t,a,i){return q`
      <div class="setting-row">
        <div class="setting-label">
          ${e}${t?q` <span class="unit">(${t})</span>`:""}
        </div>
        <input
          class="field"
          type="text"
    ...
    `}_numRow(e,t,a,i,n=1,s=!1){const r=(String(n).split(".")[1]||"").length,o=(e,t)=>{const a=parseFloat(e.value),s=+((isNaN(a)?0:a)+t*n).toFixed(r);e.value=String(s),i(String(s))};return q`
      <div class="setting-row">
        <div class="setting-label">
          ${e}${t?q` <span class="unit">(${t})</span>`:""}
        </div>
    ...
    `}_actionBtn(e,t,a,i=!1,n=!1){return q`
      <ha-button
    ...
    `}static get styles(){return l`
      ${cl} ${hl} /* View-specific styles only - most common styles are now in globalStyle */
...
a.version="2.31.0",i(ii),a.fn=fs,a.min=oi,a.max=li,a.now=di,a.utc=m,a.unix=bs,a.months=Ss,a.isDate=u,a.locale=_a,a.invalid=f,a.duration=Hi,a.isMoment=z,a.weekdays=As,a.parseZone=ks,a.localeData=xa,a.isDuration=hi,a.monthsShort=js,a.weekdaysMin=Ds,a.defineLocale=za,a.updateLocale=wa,a.locales=Sa,a.weekdaysShort=$s,a.normalizeUnits=D,a.relativeTimeRounding=pr,a.relativeTimeThreshold=mr,a.calendarFormat=Gi,a.prototype=fs,a.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},a}()),Ml.exports),Nl=$l(Ol);let Pl=class extends(Qo(de)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:mr+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,t,a,i]=await Promise.all([qo(this.hass),Ro(this.hass),Fo(this.hass),Zo(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",mr+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",mr+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",mr+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",mr+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:Al.Automatic,duration:0,bucket:0,module:void 0,delta:0,et_deficiency:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,t){this.hass&&(this.zones[e]=t,t.id&&this.zoneCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(t).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;if(!this.zones[t]||null==a)return;const i=[...this.zones];var n,s;this.zones=this.zones.filter(((e,a)=>a!==t)),this.zoneCache.delete(a.toString()),this.isSaving=!0,(n=this.hass,s=a.toString(),n.callApi("POST",mr+"/zones",{id:s,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",mr+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",mr+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var t;const a=this.zones[e];if(!a||null==a.mapping)return;const i=`#weather-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var t;const a=this.zones[e];if(!a||null==a.id)return;const i=`#calendar-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const t=await Ko(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,t)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const a of this.zones)if(void 0!==a.id)try{const i=await(e=this.hass,t=a.id.toString(),e.callWS({type:mr+"/watering_calendar",zone_id:t}));this.wateringCalendars.set(a.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${a.id}:`,e)}var e,t;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return q``;const t=this.weatherRecords.get(e.id)||[];return q`
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return q``;const t=this.wateringCalendars.get(e.id),a=t&&e.id in t?t[e.id]:null,i=(null==a?void 0:a.monthly_estimates)||[];return q` <div class="watering-calendar">
      ...
      ${0===i.length?q`
          ...
          `:q` <div class="calendar-table">
            ...
            ${(null==a?void 0:a.calculation_method)?q`
                  <div class="calendar-info">
                    Method: ${a.calculation_method}
                  </div>
                `:""}`}
    </div>`}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Uo(this.hass,e)}handleZoneFormFocus(){this.isCreatingZone=!0}handleZoneFormBlur(){var e,t,a,i;(null===(t=null===(e=this.nameInput)||void 0===e?void 0:e.value)||void 0===t?void 0:t.trim())||(null===(a=this.sizeInput)||void 0===a?void 0:a.value)||(null===(i=this.throughputInput)||void 0===i?void 0:i.value)||(this.isCreatingZone=!1)}groupDecidesEngine(e){if(void 0===e.mapping||null===e.mapping)return!1;const t=this.mappings.find((t=>t.id===e.mapping));return void 0!==(null==t?void 0:t.module)&&null!==(null==t?void 0:t.module)}renderTheOptions(e,t,a){if(this.hass){let i=q`<option value="" ?selected=${void 0===t}">---${dr("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,n])=>i=q`${i}
            <option
              value="${n.id}"
              ?selected="${t===n.id}"
            >
              ${a?a(n):`${n.id}: ${n.name}`}
            </option>`)),i}return q``}renderZone(e,t){var a,i,n,s,r;if(!this.hass)return q``;const o=this.hass.language,l=e.state===Al.Automatic,d=e.state===Al.Disabled||e.state===Al.Automatic,u=null!=e.explanation&&e.explanation.length>0;if(null!=e.mapping){const t=this.mappings.filter((t=>t.id===e.mapping))[0];null!=t&&null!=t.data&&(e.number_of_data_points=t.data.length)}const c=dr("panels.zones.labels.states."+e.state,o),p=q`${Po(e.duration)}
    (${function(e,t){const a=Number(e)||0,i=Number(t)||0;return a<=0||i<=0?0:a/60*i}(e.duration,e.throughput).toFixed(1)}
    ${No(this.config,co)})`,m=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="zone-card">
        ...
        ${m?q` <div class="zone-body">
              ...
              <div class="settings">
                ...
                ${this._selectRow(dr("panels.zones.labels.input-method",o),q`
                    <option
                      value="${xo}"
                    ...
                    <option
                      value="${So}"
                      ?selected=${e.input_method===So}
                    >
                      ${dr("panels.zones.labels.input-methods.direct",o)}
                    </option>
                  `,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[wo]:a.target.value}))))}
                ${e.input_method===So?this._numRow(dr("panels.zones.labels.precipitation-rate",o),No(this.config,jo),e.precipitation_rate,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[jo]:parseFloat(a)}))),.1):q`
                ...
                ${this._selectRow(dr("panels.zones.labels.state",o),q`
                    <option
                      value="${Al.Automatic}"
                ...
                ${this.groupDecidesEngine(e)?q`<div class="weather-note">
                      ${dr("panels.zones.module-comes-from-the-group",o)}
                    </div>`:this._selectRow(dr("common.labels.module",o),this.renderTheOptions(this.modules,e.module,(e=>Bo(e.name,o))),(a=>{const i=a.target.value;this.handleEditZone(t,Object.assign(Object.assign({},e),{[po]:""===i?void 0:parseInt(i)}))}))}
              ...
              <div class="zone-actions">
                ${l?q`
                      ${this._actionBtn(Xo,dr("panels.zones.actions.calculate",o),(()=>this.handleCalculateZone(t)))}
                      ${this._actionBtn(dl,dr("panels.zones.actions.update",o),(()=>this.handleUpdateZone(t)))}
                    `:""}
                ${this._actionBtn(rl,dr("panels.zones.actions.reset-bucket",o),(()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[mo]:0}))))}
                ${null!=e.mapping?this._actionBtn(al,dr("panels.zones.actions.view-weather-info",o),(()=>this.handleViewWeatherInfo(t))):""}
                ...
                ${this._actionBtn(il,dr("common.actions.delete",o),(e=>this.handleRemoveZone(e,t)),!0)}
              </div>

              ${u?q`<label class="hidden" id="calcresults${t}"
    ...
    `}_entityRow(e,t,a,i,n,s){return q`
      <div class="setting-row">
        <div class="setting-label">
          ${e}${t?q` <span class="unit">(${t})</span>`:""}
          ${s?q`<div class="setting-hint">${s}</div>`:""}
        </div>
        <ha-entity-picker
          class="entity-field"
          .hass=${this.hass}
    ...
    `}toggleExplanation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#calcresults"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="explanation")}render(){return this.hass?this.isLoading?q`
      ...
      ${Sl(this.zones,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderZone(e,t)))}
      ...
      >
        <div class="card-content">
          <div class="zone-actions-grid">
            ${this._actionBtn(Xo,dr("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language),(()=>this.handleCalculateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(dl,dr("panels.zones.cards.zone-actions.actions.update-all",this.hass.language),(()=>this.handleUpdateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(rl,dr("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),(()=>this.handleResetAllBuckets()),!1,this.isSaving)}
            ${this._actionBtn(al,dr("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),(()=>this.handleClearAllWeatherdata()),!1,this.isSaving)}
          </div>
        </div>
      </ha-card>
    `:q``}disconnectedCallback(){super.disconnectedCallback(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.zoneCache.clear(),this.isCreatingZone=!1}static get styles(){return l`
      ${cl}
    ...
    `;return this.moduleCache.set(l,d),d}renderConfig(e,t){const a=Object.values(this.modules).at(e);if(!a||!this.hass)return;const i=a.schema[t],n=i.name,s=function(e){if(e)return(e=e.replace("_"," ")).charAt(0).toUpperCase()+e.slice(1)}(n);let r="";null==a.config&&(a.config=[]),n in a.config&&(r=a.config[n]);const o=i.required?`${s} *`:null!=s?s:"";if("boolean"==i.type)return q`
      ...
      `;if("float"==i.type||"integer"==i.type)return this._numRow(o,"",a.config[n],(t=>this.handleEditConfig(e,Object.assign(Object.assign({},a),{config:Object.assign(Object.assign({},a.config),{[n]:t})}))),1);if("string"==i.type)return this._textRow(o,"",r,(t=>this.handleEditConfig(e,Object.assign(Object.assign({},a),{config:Object.assign(Object.assign({},a.config),{[n]:t})}))));if("select"==i.type){const t=this.hass.language,s=q`
        ${Object.entries(i.options).map((([e,a])=>q`<option
              value="${To(a,0)}"
              ?selected="${r===To(a,0)}"
            >
              ${dr("panels.modules.cards.module.translated-options."+To(a,1),t)}
            </option>`))}
      `;return this._selectRow(o,s,(t=>this.handleEditConfig(e,Object.assign(Object.assign({},a),{config:Object.assign(Object.assign({},a.config),{[n]:t.target.value})}))))}return q``}_textRow(e,t,a,i){return q`
      <div class="setting-row">
        <div class="setting-label">
          ${e}${t?q` <span class="unit">(${t})</span>`:""}
        </div>
    ...
    `}handleEditConfig(e,t){this.modules=Object.values(this.modules).map(((a,i)=>i===e?t:a)),this.moduleCache.clear(),this._scheduleUpdate(),this.debouncedSave(t)}renderOption(e,t){return this.hass?q`<option value="${e}>${t}</option>`:q``}render(){return this.hass?q`
                ...
                <div class="setting-row">
                  ...
                  <div class="select-wrap">
                    <select
                      ...
                      ?disabled="${this.isSaving}"
                    >
                      ${Object.entries(this.allmodules).map((([e,t])=>q`<option value="${t.id}">
                            ${t.name}
                          </option>`))}
                    </select>
                    <svg class="chev" viewBox="0 0 24 24">
      ...
      ${this.isLoading?q`<div class="loading-indicator">
          ...
          </div>`:Sl(this.modules,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderModule(e,t)))}
    `:q``}disconnectedCallback(){super.disconnectedCallback(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.moduleCache.clear()}static get styles(){return l`
      ${cl} ${hl} /* View-specific styles only - most common styles are now in globalStyle */
    `}};a([me()],Hl.prototype,"config",void 0),a([me({type:Array})],Hl.prototype,"zones",void 0),a([me({type:Array})],Hl.prototype,"modules",void 0),a([me({type:Array})],Hl.prototype,"allmodules",void 0),a([me({type:Boolean})],Hl.prototype,"isLoading",void 0),a([me({type:Boolean})],Hl.prototype,"isSaving",void 0),a([he("#moduleInput")],Hl.prototype,"moduleInput",void 0),Hl=a([ce("smart-irrigation-view-modules")],Hl);let Cl=class extends(Qo(de)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16,this._expanded=new Set,this.modules=[]}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}),this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()})))}_toggleItem(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:mr+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,t,a,i]=await Promise.all([qo(this.hass),Ro(this.hass),Zo(this.hass),Fo(this.hass)]);this.config=e,this.zones=t,this.mappings=a,this.modules=i,this._fetchWeatherRecords(),this.mappingCache.clear()}catch(t){console.error("Error fetching data:",t),Co({body:{message:"Failed to load mapping data"},error:"Data fetch error"},null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-card"))}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const t=await Ko(this.hass,e.id.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for mapping ${e.id}:`,t),this.weatherRecords.set(e.id,[])}this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass)return q``;const t=void 0!==e.id&&this.weatherRecords.get(e.id)||[];return q`
      <div class="weather-records">
        <h4>
          ${dr("panels.mappings.weather-records.title",this.hass.language)}
        </h4>
          ...
          <div class="card-content">
            ...
            <div class="setting-row">
              ...
              >
                ...
                ${this.modules.map((t=>q`<option
                      value="${t.id}"
                      ?selected=${t.id===e.module}
                    >
                      ${Bo(t.name,this.hass.language)}
                    </option>`))}
              </select>
            </div>
            <div class="weather-note">
            ...
            ${e.greenhouse?q`<div class="weather-note">
    ...
    `;return this.mappingCache.set(a,n),n}renderMappingSetting(e,t){const a=this.mappings[e];if(!a||!this.hass)return q``;const i=a.mappings[t];return q`
    ...
    `}renderSimpleRadioOptions(e,t,a){if(!this.hass||!this.config)return q``;const i=t===Sr||t===Or,n=a[Wr],s=t===Dr,r=!!this.config.use_weather_service&&!s,o=i||s,l=i&&this.config.weather_service!==Hr;return q`
      ${r?q`<option
            value="${Ir}"
            ?selected=${n===Ir}
          >
    ...
    `}renderWeatherServiceOption(e,t,a){if(!this.hass||!this.config)return q``;const i=`${t}_${e}`,n=!this.config.use_weather_service,s=this.config.use_weather_service&&a[Wr]===Ir,r=(t===Sr||t===Or)&&this.config.weather_service!==Hr;return q`
    ...
    `}renderNoneOption(e,t,a){if(!this.hass)return q``;const i=`${t}_${e}`,n=a[Wr]===Fr;return q`
      <label>
        <input
          type="radio"
          id="${i}_none"
    ...
    `}renderSensorOption(e,t,a){if(!this.hass)return q``;const i=`${t}_${e}`,n=a[Wr]===Lr;return q`
      <label>
        <input
          type="radio"
          id="${i}_sensor"
    ...
    `}renderStaticValueOption(e,t,a){if(!this.hass)return q``;const i=`${t}_${e}`,n=a[Wr]===Br;return q`
      <label>
        <input
          type="radio"
          id="${i}_static"
    ...
    `}handleSourceChange(e,t,a){const i=this.mappings[e],n=a.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Wr]:n,[Yr]:""})})}))}renderMappingInputs(e,t,a){if(!this.hass)return q``;const i=a[Wr];return q`
      ${i===Lr||i===qr?this.renderSensorInput(e,t,a):""}
      ${i===qr?this.renderLuminousEfficacyInput(e,t,a):""}
      ${i===Br?this.renderStaticValueInput(e,t,a):""}
      ${i===Lr||i===Br?this.renderUnitSelect(e,t,a):""}
      ${t!==Tr||i!==Lr&&i!==Br?"":this.renderPressureTypeSelect(e,t,a)}
      ${i===Lr||i===qr?this.renderAggregateSelect(e,t,a):""}
    `}renderSensorInput(e,t,a){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
    ...
    `:q``}renderLuminousEfficacyInput(e,t,a){var i;return this.hass?this._numRow(dr("panels.mappings.cards.mapping.luminous_efficacy",this.hass.language),"lm/W",null!==(i=a[Gr])&&void 0!==i?i:110,(a=>this.handleLuminousEfficacyChange(e,t,{target:{value:a}})),1):q``}handleLuminousEfficacyChange(e,t,a){const i=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Gr]:parseFloat(a.target.value)})})}))}renderStaticValueInput(e,t,a){return this.hass?this._numRow(dr("panels.mappings.cards.mapping.static_value",this.hass.language),"",a[Zr]||"",(a=>this.handleStaticValueChange(e,t,{target:{value:a}})),.1):q``}renderUnitSelect(e,t,a){return this.hass&&this.config?this._selectRow(dr("panels.mappings.cards.mapping.input-units",this.hass.language),this.renderUnitOptionsForMapping(t,a),(a=>this.handleUnitChange(e,t,a))):q``}renderPressureTypeSelect(e,t,a){return this.hass?this._selectRow(dr("panels.mappings.cards.mapping.pressure-type",this.hass.language),this.renderPressureTypes(t,a),(a=>this.handlePressureTypeChange(e,t,a))):q``}renderAggregateSelect(e,t,a){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return q`<option value="${e}" ?selected="${e===t}">
        ...
        </option>`,e}return q``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return q``;const a=function(e){switch(e){case xr:case Nr:return[{unit:Xr,system:wr},{unit:"°F",system:zr}];case Dr:case Sr:return[{unit:eo,system:wr},{unit:"in",system:zr}];case Mr:return[{unit:io,system:wr},{unit:no,system:zr}];case jr:return[{unit:"%",system:[wr,zr]}];case Tr:return[{unit:"millibar",system:wr},{unit:"hPa",system:wr},{unit:"psi",system:zr},{unit:"inch Hg",system:zr}];case Pr:return[{unit:"km/h",system:wr},{unit:to,system:wr},{unit:"mile/h",system:zr},{unit:"knot",system:[wr,zr]}];case Or:return[{unit:"W/m2",system:wr},{unit:ao,system:wr},{unit:"W/sq ft",system:zr},{unit:"MJ/day/sq ft",system:zr}];default:return[]}}(e);let i=t[Kr];const n=this.config.units;if(!t[Kr])for(const e of a)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const t of e.system)if(n===t.system){i=e.unit;break}if(i===e.unit)break}return q`
      ${a.map((e=>q`
    ...
    `:q``}renderMappingsList(){const e=this.mappings.slice(0,Math.min(this.mappings.length,10)),t=this.mappings.slice(10);return q`
      ${Sl(e,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderMappingCard(e,t)))}
      ${t.length>0?q`
            <div class="si-form-actions">
              ${this._actionBtn(ol,`Load ${t.length} more mappings...`,(()=>this.loadMoreMappings()))}
            </div>
          `:""}
    `}renderMappingCard(e,t){if(!this.hass)return q``;const a=this.hass.language,i=this.zones.filter((t=>t.mapping===e.id)).length,n=Object.keys(e.mappings||{}).length,s=[];s.push(`${n} ${dr("panels.mappings.title",a).toLowerCase()}`),i&&s.push(`${i} ${dr("panels.zones.title",a).toLowerCase()}`);const r=s.join(" · "),o=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="si-card">
        <div
          class="si-head"
          role="button"
        ...
        ${o?q`<div class="si-body">
              ...
              <div class="si-actions">
                ${i?q`<div class="weather-note">
                    ...
                    </div>`:this._actionBtn(il,dr("common.actions.delete",a),(e=>this.handleRemoveMapping(e,t)),!0)}
              </div>
            </div>`:""}
      </ha-card>
    `}renderMappingSettings(e,t){const a=Object.entries(e.mappings);return q`
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach((e=>{clearTimeout(e)})),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};a([me()],Cl.prototype,"config",void 0),a([me({type:Array})],Cl.prototype,"zones",void 0),a([me({type:Array})],Cl.prototype,"mappings",void 0),a([me({type:Map})],Cl.prototype,"weatherRecords",void 0),a([me({type:Boolean})],Cl.prototype,"isLoading",void 0),a([me({type:Boolean})],Cl.prototype,"isSaving",void 0),a([me({type:Array})],Cl.prototype,"modules",void 0),a([he("#mappingNameInput")],Cl.prototype,"mappingNameInput",void 0),Cl=a([ce("smart-irrigation-view-mappings")],Cl);const Il={[Nr]:{unit:Xr,decimals:1},[$r]:{unit:Xr,decimals:1},[Ar]:{unit:Xr,decimals:1},[xr]:{unit:Xr,decimals:1},[jr]:{unit:"%",decimals:0},[Tr]:{unit:"hPa",decimals:0},[Pr]:{unit:to,decimals:1},[Or]:{unit:ao,decimals:2},[Dr]:{unit:eo,decimals:2},[Mr]:{unit:io,decimals:2},[Sr]:{unit:eo,decimals:2}};let Ll=class extends de{constructor(){super(...arguments),this._use=!1,this._service=null,this._apiKey="",this._loading=!0,this._saving=!1,this._error="",this._saved=!1,this._historyLoading=!1,this._historyError=""}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)})),this._load()}async _load(){if(this.hass){try{const e=await Vo(this.hass);this._info=e,this._use=!!e.use_weather_service,this._service=e.weather_service||(e.services&&e.services.includes(Hr)?Hr:e.services&&e.services.length?e.services[0]:null),this._apiKey=e.weather_service_api_key||"",this._error=""}catch(e){this._error=this._errText(e)}finally{this._loading=!1}this._loadHistory()}}async _loadHistory(){if(this.hass){this._historyLoading=!0;try{this._history=await((e,t=20)=>e.callWS({type:mr+"/weatherservice_history",limit:t}))(this.hass,20),this._historyError=""}catch(e){this._historyError=this._errText(e)}finally{this._historyLoading=!1}}}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}async _save(){if(this.hass){this._saving=!0,this._error="",this._saved=!1;try{await(e=this.hass,t={use_weather_service:this._use,weather_service:this._use?this._service:null,weather_service_api_key:this._use?this._apiKey:null},e.callWS(Object.assign({type:mr+"/set_weatherservice"},t))),this._saved=!0,window.setTimeout((()=>this._load()),800)}catch(e){this._error=this._errText(e)}finally{this._saving=!1}var e,t}}render(){var e;if(!this.hass)return q``;const t=this.hass.language;return this._loading&&!this._info?q`
      ...
      <ha-card header="${dr("panels.weatherservice.title",t)}">
        ...
        <div class="card-content">
          ...
          ${this._use?q`
                ...
                ${this._service&&Cr.includes(this._service)?"":q`<div class="setting-row">
                      <div class="setting-label">
    ...
    `}_formatTime(e){if(!e.retrieved)return"-";const t=Nl(e.retrieved);return t.isValid()?t.format("YYYY-MM-DD HH:mm"):"-"}_formatValue(e,t){var a,i;return null==t||isNaN(t)?"-":t.toFixed(null!==(i=null===(a=Il[e])||void 0===a?void 0:a.decimals)&&void 0!==i?i:1)}static get styles(){return l`
      ${cl} ${hl}
    ...
    `}};a([me()],Ll.prototype,"narrow",void 0),a([me()],Ll.prototype,"path",void 0),a([ge()],Ll.prototype,"_info",void 0),a([ge()],Ll.prototype,"_use",void 0),a([ge()],Ll.prototype,"_service",void 0),a([ge()],Ll.prototype,"_apiKey",void 0),a([ge()],Ll.prototype,"_loading",void 0),a([ge()],Ll.prototype,"_saving",void 0),a([ge()],Ll.prototype,"_error",void 0),a([ge()],Ll.prototype,"_saved",void 0),a([ge()],Ll.prototype,"_history",void 0),a([ge()],Ll.prototype,"_historyLoading",void 0),a([ge()],Ll.prototype,"_historyError",void 0),Ll=a([ce("smart-irrigation-view-weatherservice")],Ll);const Bl=10,ql=8,Vl=26,Rl=46;let Ul=class extends(Qo(de)){constructor(){super(...arguments),this._records=[],this._loading=!0,this._error=""}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial history:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to refresh history:",e)}))}),{type:mr+"_config_updated"})]}async _fetchData(){if(this.hass)try{const[e,t]=await Promise.all([qo(this.hass),Jo(this.hass,500)]);this._config=e,this._records=(null==t?void 0:t.records)||[],this._error=""}catch(e){this._error=(null==e?void 0:e.message)||(null==e?void 0:e.code)||String(e)}finally{this._loading=!1}}_chartDays(){const e=Nl().startOf("day").subtract(29,"days"),t=[];for(let a=0;a<30;a++)t.push(e.clone().add(a,"days").format("YYYY-MM-DD"));return t}_daily(e,t){const a=new Map(e.map((e=>[e,0])));for(const e of this._records){if(!e.start||t&&!t(e))continue;const i=Nl(e.start);if(!i.isValid())continue;const n=i.format("YYYY-MM-DD");a.has(n)&&a.set(n,a.get(n)+Ho(e.water_used,this._config))}return e.map((e=>({key:e,value:a.get(e)})))}_chartedZones(e){const t=e[0],a=new Map;for(const e of this._records){if(!e.start)continue;const i=Nl(e.start);if(!i.isValid()||i.format("YYYY-MM-DD")<t)continue;const n=null!==e.zone_id?`#${e.zone_id}`:e.zone_name||"?";a.has(n)||a.set(n,{id:e.zone_id,name:e.zone_name||n})}return[...a.values()].sort(((e,t)=>e.name.localeCompare(t.name)))}render(){if(!this.hass)return q``;const e=this.hass.language;if(this._loading)return q`
        <ha-card header="${dr("panels.history.title",e)}">
          <div class="card-content">
            ${dr("common.loading-messages.general",e)}...
          </div>
        </ha-card>
      `;const t=this._chartDays(),a=this._chartedZones(t);return q`
      <ha-card header="${dr("panels.history.title",e)}">
        <div class="card-content">
          <div class="history-intro">
            ${dr("panels.history.description",e)}
          </div>
          ${this._error?q`<div class="history-msg history-msg--error">
                ${this._error}
              </div>`:""}
      ...
      ${this._config?q`${this._renderTable(e)} ${this._renderTotalChart(e,t)}
          ${this._renderZoneCharts(e,t,a)}`:""}
    `}_renderTable(e){const t=this._records.slice(0,100),a=No(this._config,co);return q`
      <ha-card header="${dr("panels.history.table.title",e)}">
        <div class="card-content">
          ${0===t.length?q`<div class="history-note">
                  ...
                  <div class="history-table">
                    ...
                    ${t.map((e=>q`
                        <div class="history-row">
                          ...
                          <span>${Po(e.duration)}</span>
                          <span
                            >${Ho(e.water_used,this._config).toFixed(1)}</span
                          >
                        </div>
                      `))}
                  </div>
                </div>
                ${this._records.length>100?q`<div class="history-note">
                      ${dr("panels.history.table.truncated",e,"{count}",100,"{total}",this._records.length)}
                    </div>`:""}
              `}
        </div>
      </ha-card>
    `}_renderTotalChart(e,t){const a=this._daily(t);return q`
      <ha-card header="${dr("panels.history.charts.total-title",e)}">
        <div class="card-content">${this._renderChart(a,e)}</div>
      </ha-card>
    `}_renderZoneCharts(e,t,a){return 0===a.length?q``:q`
      <ha-card
        header="${dr("panels.history.charts.per-zone-title",e)}"
      >
        <div class="card-content">
          ${a.map((a=>{const i=this._daily(t,(e=>null!==a.id?e.zone_id===a.id:e.zone_name===a.name));return q`
    ...
    `}_renderChart(e,t){const a=No(this._config,co),i=Math.max(...e.map((e=>e.value)),0);if(i<=0)return q`<div class="history-note">
        ${dr("panels.history.charts.no-data",t)}
      </div>`;const n=this._niceMax(i),s=200-Bl-Vl,r=Bl+s,o=(720-Rl-ql)/e.length,l=Math.max(o-3,1),d=[0,.5,1].map((e=>{const t=r-e*s;return V`
        <line
          class="grid"
          x1=${Rl}
          y1=${t}
          ...
          y2=${t}
        ></line>
        <text class="axis" x=${Rl-6} y=${t+3.5} text-anchor="end">
      ...
      `})),u=e.map(((e,t)=>{const a=e.value/n*s;return V`
        ...
        >
          <title>
            ${Oo(e.key,this.hass,{dateStyle:"long"})}: ${e.value.toFixed(1)}
          </title>
        </rect>
      `})),c=e.map(((t,a)=>a%5!=0&&a!==e.length-1?V``:V`
        <text
          ...
          text-anchor="middle"
        >
          ${Oo(t.key,this.hass,{day:"numeric",month:"short"})}
        </text>
      `));return q`
        ...
        <div class="card-content">
          ...
          <label class="br-file">
            <input
              ...
              @change=${this._onFile}
            />
            <ha-svg-icon .path=${ul}></ha-svg-icon>
          ...
          ${this._pending?q`<div class="br-actions">
                <ha-button
                  ...
                  @click=${this._restore}
                >
                  <ha-svg-icon slot="start" .path=${ul}></ha-svg-icon>
    ...
    `}};a([me()],Fl.prototype,"narrow",void 0),a([me()],Fl.prototype,"path",void 0),a([ge()],Fl.prototype,"_busy",void 0),a([ge()],Fl.prototype,"_error",void 0),a([ge()],Fl.prototype,"_message",void 0),a([ge()],Fl.prototype,"_pending",void 0),a([ge()],Fl.prototype,"_pendingName",void 0),Fl=a([ce("smart-irrigation-view-backuprestore")],Fl);let Wl=class extends(Qo(de)){constructor(){super(...arguments),this.zones=[],this.isLoading=!0,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:mr+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[t,a,i]=await Promise.all([qo(this.hass),(e=this.hass,e.callWS({type:mr+"/info"})),Ro(this.hass)]);this.config=t,this.info=a,this.zones=i}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}get _lang(){var e,t;return null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en"}t(e){return dr(`panels.info.${e}`,this._lang)}formatDuration(e){const t=Math.max(0,Math.round(null!=e?e:0)),a=dr("common.units.hours",this._lang),i=dr("common.units.minutes",this._lang),n=dr("common.units.seconds",this._lang);if(t<60)return`${t} ${n}`;if(t<3600)return`${Math.round(t/60)} ${i}`;const s=Math.floor(t/3600),r=Math.round(t%3600/60);return r?`${s} ${a} ${r} ${i}`:`${s} ${a}`}render(){return this.hass?this.isLoading?q`
    ...
    `:q`
      ...
      `:q``}renderNextRun(){var e,t;const a=this.info,i=null!==(e=null==a?void 0:a.next_irrigation_zones)&&void 0!==e?e:[];return q`
      <ha-card header="${this.t("cards.next-run.title")}">
        <div class="card-content">
          ${(null==a?void 0:a.next_irrigation_start)?q`
                <div class="info-item">
                  <label>${this.t("cards.next-run.labels.start")}</label>
                  <span class="value"
                    >${Oo(a.next_irrigation_start,this.hass,{weekday:"short",day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"})}</span
                  >
                </div>
                <div class="info-item">
          ...
          ${(null==a?void 0:a.zone_sequencing)?q`<div class="info-note">
    ...
    `}renderDecision(){var e;const t=null===(e=this.info)||void 0===e?void 0:e.skip_preview;return q`
    ...
    `}renderCheck(e){let t="passing";return e.enabled?e.available?e.skip&&(t="blocking"):t="unavailable":t="off",q`
      <div class="check">
        ...
        ${e.enabled&&e.available?q`<div class="check-detail">
              ${this.renderCheckNumbers(e)}
            </div>`:""}
      </div>
    `}renderCheckNumbers(e){var t,a,i,n,s,r;return"precipitation"===e.id?q`
        <span
      ...
      `:"days_between"===e.id?q`
        ...
        >
      `:q``}renderLastDecision(){var e;const t=null===(e=this.info)||void 0===e?void 0:e.last_skip_evaluation;return q`
      <div class="last-decision">
        <span class="check-name">${this.t("cards.decision.last-title")}</span>
        ${t?q`<span class="value"
              >${t.should_skip?this.t("cards.decision.last-skipped"):this.t("cards.decision.last-ran")}${t.evaluated_at?` (${Oo(t.evaluated_at,this.hass,{weekday:"short",day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"})})`:""}</span
            >`:q`<span class="value"
              >${this.t("cards.decision.last-none")}</span
            >`}
      </div>
    `}renderEstimates(){var e,t;const a=null!==(t=null===(e=this.info)||void 0===e?void 0:e.zone_estimates)&&void 0!==t?t:{},i=this.config?No(this.config,mo):"mm",n=this.zones.filter((e=>a[String(e.id)]));return q`
      <ha-card header="${this.t("cards.estimate.title")}">
        <div class="card-content">
          ${0===n.length?q`<div class="info-note">
                ${this.t("cards.estimate.none")}
              </div>`:q`
                ${n.map((e=>{const t=a[String(e.id)];return q`
                    <div class="zone-info">
                      ...
                      <div class="zone-details">
                        ...
                        <div class="pair">
                          ...
                          >
                          <span class="value"
                            >${e.last_irrigation?Oo(e.last_irrigation,this.hass,{weekday:"short",day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"}):this.t("cards.estimate.never-watered")}</span
                          >
                        </div>
                      </div>
                    </div>
    ...
    `}};a([me()],Wl.prototype,"config",void 0),a([me({type:Object})],Wl.prototype,"info",void 0),a([me({type:Array})],Wl.prototype,"zones",void 0),a([me({type:Boolean})],Wl.prototype,"isLoading",void 0),Wl=a([ce("smart-irrigation-view-info")],Wl);const Yl=[Nr,xr,jr,Tr,Pr,Or,Sr,Dr,Mr],Zl={sensors:"PyETO",et:"Passthrough",static:"Static"};let Gl=class extends de{constructor(){super(...arguments),this.step=0,this.allModules=[],this.modules=[],this.isSaving=!1,this.done=!1,this.zoneName="",this.zoneSize="",this.zoneThroughput="",this.underGlass=!1,this.weather="service",this.sensors={},this.staticDelta="",this.serviceSuppliesEt=!1}firstUpdated(){ke().catch((()=>{})),this._load().catch((e=>console.error("Setup wizard: load failed",e)))}async _load(){if(!this.hass)return;const[e,t,a,i]=await Promise.all([qo(this.hass),Wo(this.hass),Fo(this.hass),Vo(this.hass).catch((()=>{}))]);this.config=e,this.allModules=t,this.modules=a,this.serviceSuppliesEt=!!(null==i?void 0:i.supplies_evapotranspiration),this.usesWeatherService||(this.weather="sensors")}get lng(){var e,t;return null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en"}t(e){return dr(`panels.setup.${e}`,this.lng)}get usesWeatherService(){var e;return!!(null===(e=this.config)||void 0===e?void 0:e.use_weather_service)}get engineName(){return"service"===this.weather?this.serviceSuppliesEt?"Passthrough":"PyETO":Zl[this.weather]}get sourcesToAsk(){var e;const t=this.allModules.find((e=>e.name===this.engineName)),a=null!==(e=null==t?void 0:t.consumes)&&void 0!==e?e:Yl;return Yl.filter((e=>a.includes(e)&&!(this.underGlass&&(e===Dr||e===Mr))))}get sensorsToAsk(){return"static"===this.weather?[]:"et"===this.weather?[Sr]:"sensors"===this.weather?this.sourcesToAsk:[]}get steps(){const e=["zone","environment","weather"];return(this.sensorsToAsk.length||"static"===this.weather)&&e.push("sensors"),e.push("review"),e}get currentStep(){return this.steps[Math.min(this.step,this.steps.length-1)]}get canGoOn(){switch(this.currentStep){case"zone":return""!==this.zoneName.trim()&&Number(this.zoneSize)>0&&Number(this.zoneThroughput)>0;case"sensors":return"static"===this.weather?Number(this.staticDelta)>0:this.sensorsToAsk.every((e=>{var t;return""!==(null!==(t=this.sensors[e])&&void 0!==t?t:"")}));default:return!0}}render(){return this.hass?this.done?q`
        <ha-card header="${this.t("title")}">
          <div class="card-content">
      ...
      <ha-card header="${this.t("title")}">
        <div class="card-content">
          ...
          <div class="si-form-actions">
            ...
            ${"review"===this.currentStep?q`<ha-button
                  appearance="filled"
                  ?disabled=${this.isSaving}
                  @click=${()=>this.create()}
                >
    ...
    `}renderEnvironmentStep(){return q`
    ...
    `}renderWeatherStep(){return q`
      ...
      ${this.underGlass?q`<div class="note">
    ...
    `}choice(e,t,a,i){return q`
      <div class="choice ${e?"selected":""}" @click=${i}>
        <div class="choice-title">${t}</div>
        <div class="choice-help">${a}</div>
      </div>
    `}sourceFor(e){return this.sensors[e]?{[Wr]:Lr,[Yr]:this.sensors[e],[Kr]:""}:"service"===this.weather&&this.sourcesToAsk.includes(e)?{[Wr]:Ir,[Yr]:"",[Kr]:""}:!this.underGlass||e!==Dr&&e!==Mr?{[Wr]:Fr,[Yr]:"",[Kr]:""}:{[Wr]:Br,[Yr]:"",[Kr]:"",[Zr]:0}}async create(){if(this.hass&&!this.isSaving){this.isSaving=!0,this.error=void 0;try{let e=this.modules.find((e=>e.name===this.engineName));if(!e){const t=this.allModules.find((e=>e.name===this.engineName));if(!t)throw new Error(`Unknown calculation engine ${this.engineName}`);const a="static"===this.weather?Object.assign(Object.assign({},t.config),{delta:Number(this.staticDelta)}):t.config;await Yo(this.hass,{name:t.name,description:t.description,config:a,schema:t.schema});const i=await Fo(this.hass);this.modules=i,e=i.find((e=>e.name===this.engineName))}const t={name:this.zoneName.trim(),mappings:Object.fromEntries(Yl.map((e=>[e,this.sourceFor(e)]))),greenhouse:this.underGlass,[Er]:null==e?void 0:e.id};await Go(this.hass,t);const a=(await Zo(this.hass)).find((e=>e.name===t.name));await Uo(this.hass,{name:this.zoneName.trim(),size:Number(this.zoneSize),throughput:Number(this.zoneThroughput),state:"automatic",[ho]:null==a?void 0:a.id}),await Ro(this.hass),this.done=!0}catch(e){console.error("Setup wizard: could not create the zone",e),this.error=this.t("failed")}finally{this.isSaving=!1}}}static get styles(){return l`
      ${cl} ${hl}
    ...
    `}};a([me()],Gl.prototype,"hass",void 0),a([me()],Gl.prototype,"config",void 0),a([ge()],Gl.prototype,"step",void 0),a([ge()],Gl.prototype,"allModules",void 0),a([ge()],Gl.prototype,"modules",void 0),a([ge()],Gl.prototype,"isSaving",void 0),a([ge()],Gl.prototype,"error",void 0),a([ge()],Gl.prototype,"done",void 0),a([ge()],Gl.prototype,"zoneName",void 0),a([ge()],Gl.prototype,"zoneSize",void 0),a([ge()],Gl.prototype,"zoneThroughput",void 0),a([ge()],Gl.prototype,"underGlass",void 0),a([ge()],Gl.prototype,"weather",void 0),a([ge()],Gl.prototype,"sensors",void 0),a([ge()],Gl.prototype,"staticDelta",void 0),a([ge()],Gl.prototype,"serviceSuppliesEt",void 0),Gl=a([ce("smart-irrigation-view-setup")],Gl);const Kl=cl,Jl=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a},Ql=(e,...t)=>{let a={page:e,params:{}};t.forEach((e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}))}));const i=e=>{let t=Object.keys(e);t=t.filter((t=>e[t])),t.sort();let a="";return t.forEach((t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`})),a};let n=`/${mr}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n};var Xl;!function(e){e.Setup="setup",e.Info="info",e.General="general",e.Zones="zones",e.Modules="modules",e.Mappings="mappings",e.WeatherService="weatherservice",e.History="history",e.BackupRestore="backuprestore",e.Help="help"}(Xl||(Xl={})),e.SmartIrrigationPanel=class extends de{constructor(){super(...arguments),this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}async firstUpdated(){const e=Jl();e.page&&Object.values(Xl).includes(e.page)?(window.addEventListener("location-changed",(()=>{if(!window.location.pathname.includes("smart_irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())})),ke().then((()=>{this._scheduleUpdate()})).catch((e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}))):Io(0,Ql(Xl.General))}render(){const e=Jl(),t=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return q`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
          ...
          <div class="version">${"v2026.9.1-beta1"}</div>
        </div>

        ${t&&a?q`
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(Xl).map((t=>q`
                    <ha-tab-group-tab
                      slot="nav"
                      panel="${t}"
                      .active=${e.page===t}
    ...
    `}getView(e){switch(e.page){case"setup":return q`
        ...
        `}}navigateToPage(e){if(e!==Jl().page){const t=Ql(e);Io(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Jl().page){const e=Ql(t);Io(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Kl,l`
        :host {
          color: var(--primary-text-color);
    ...
    `}};a([me({attribute:!1})],ed.prototype,"hass",void 0),a([ge()],ed.prototype,"_params",void 0),ed=a([ce("smart-irrigation-error-dialog")],ed);var td=Object.freeze({__proto__:null,get ErrorDialog(){return ed}})}({});
