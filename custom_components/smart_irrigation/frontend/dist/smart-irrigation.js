    ...
    `}_addTrigger(){this._showTriggerDialog({createTrigger:!0})}_editTrigger(e){var t,a;const i=null===(a=null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||void 0===a?void 0:a[e];i&&this._showTriggerDialog({trigger:i,triggerIndex:e})}_deleteTrigger(e){var t,a;if(!(null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||!this.hass)return;const i=(null===(a=this.config.irrigation_start_triggers[e])||void 0===a?void 0:a.name)||"Unknown";if(confirm(dr("irrigation_start_triggers.confirm_delete",this.hass.language).replace("{name}",i))){const t=[...this.config.irrigation_start_triggers];t.splice(e,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[hr]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}}async _showTriggerDialog(e){if(!this.hass)return;const t=document.createElement("smart-irrigation-trigger-dialog");t.hass=this.hass,t.addEventListener("trigger-save",(e=>{this._handleTriggerSave(e.detail)})),t.addEventListener("trigger-delete",(e=>{this._handleTriggerDelete(e.detail)})),document.body.appendChild(t),await t.showDialog(e),t.addEventListener("closed",(e=>{const a=e.target;a&&"ha-dialog"===a.tagName.toLowerCase()&&document.body.removeChild(t)}))}_handleTriggerSave(e){if(!this.config)return;const t=this.config.irrigation_start_triggers?[...this.config.irrigation_start_triggers]:[];e.isNew?t.push(e.trigger):void 0!==e.index&&(t[e.index]=e.trigger),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[hr]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}_handleTriggerDelete(e){var t;if(!(null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||void 0===e.index)return;const a=[...this.config.irrigation_start_triggers];a.splice(e.index,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[hr]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}renderWeatherSkipCard(){return this.config&&this.data&&this.hass?q`
      <ha-card header="${dr("weather_skip.title",this.hass.language)}">
        ...
        <div class="card-content">
          ...
          ${this.config.skip_irrigation_on_precipitation?this._numRow(dr("weather_skip.threshold_label",this.hass.language),Oo(this.config,gr),this.config.precipitation_threshold_mm,(e=>this.handleConfigChange({precipitation_threshold_mm:parseFloat(e)})),.1):""}
        </div>
      </ha-card>
...
a.version="2.31.0",i(ii),a.fn=fs,a.min=oi,a.max=li,a.now=di,a.utc=m,a.unix=bs,a.months=Ss,a.isDate=u,a.locale=_a,a.invalid=f,a.duration=Hi,a.isMoment=z,a.weekdays=As,a.parseZone=ks,a.localeData=xa,a.isDuration=hi,a.monthsShort=js,a.weekdaysMin=Ds,a.defineLocale=za,a.updateLocale=wa,a.locales=Sa,a.weekdaysShort=$s,a.normalizeUnits=D,a.relativeTimeRounding=pr,a.relativeTimeThreshold=mr,a.calendarFormat=Gi,a.prototype=fs,a.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},a}()),Ml.exports),Ol=Al(Tl);let Nl=class extends(Jo(de)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:mr+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,t,a,i]=await Promise.all([Bo(this.hass),Vo(this.hass),Uo(this.hass),Yo(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",mr+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",mr+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",mr+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",mr+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:jl.Automatic,duration:0,bucket:0,module:void 0,delta:0,et_deficiency:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,t){this.hass&&(this.zones[e]=t,t.id&&this.zoneCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(t).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;if(!this.zones[t]||null==a)return;const i=[...this.zones];var n,s;this.zones=this.zones.filter(((e,a)=>a!==t)),this.zoneCache.delete(a.toString()),this.isSaving=!0,(n=this.hass,s=a.toString(),n.callApi("POST",mr+"/zones",{id:s,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",mr+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",mr+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var t;const a=this.zones[e];if(!a||null==a.mapping)return;const i=`#weather-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var t;const a=this.zones[e];if(!a||null==a.id)return;const i=`#calendar-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const t=await Go(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,t)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const a of this.zones)if(void 0!==a.id)try{const i=await(e=this.hass,t=a.id.toString(),e.callWS({type:mr+"/watering_calendar",zone_id:t}));this.wateringCalendars.set(a.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${a.id}:`,e)}var e,t;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return q``;const t=this.weatherRecords.get(e.id)||[];return q`
              ...
              <div class="weather-table">
                ...
                ${t.slice(0,10).map((e=>q`
                    <div class="weather-row">
                      <span
                        >${Ol(e.timestamp).format("MM-DD HH:mm")}</span
                      >
                      <span
                      ...
                      >
                      <span
                        >${e.retrieval_time?Ol(e.retrieval_time).format("MM-DD HH:mm"):"-"}</span
                      >
                    </div>
                  `))}
              </div>
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return q``;const t=this.wateringCalendars.get(e.id),a=t&&e.id in t?t[e.id]:null,i=(null==a?void 0:a.monthly_estimates)||[];return q` <div class="watering-calendar">
      ...
      ${0===i.length?q`
          ...
          `:q` <div class="calendar-table">
            ...
            >
              ${a?a(n):`${n.id}: ${n.name}`}
            </option>`)),i}return q``}renderZone(e,t){var a,i,n,s,r;if(!this.hass)return q``;const o=this.hass.language,l=e.state===jl.Automatic,d=e.state===jl.Disabled||e.state===jl.Automatic,u=null!=e.explanation&&e.explanation.length>0;if(null!=e.mapping){const t=this.mappings.filter((t=>t.id===e.mapping))[0];null!=t&&null!=t.data&&(e.number_of_data_points=t.data.length)}const c=dr("panels.zones.labels.states."+e.state,o),p=q`${No(e.duration)}
    (${function(e,t){const a=Number(e)||0,i=Number(t)||0;return a<=0||i<=0?0:a/60*i}(e.duration,e.throughput).toFixed(1)}
    ${Oo(this.config,co)})`,m=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="zone-card">
        ...
        ${m?q` <div class="zone-body">
              <div class="zone-meta">
                <div class="meta-item">
                  ...
                  <span class="meta-value"
                    >${e.last_calculated?Ol(e.last_calculated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                  ...
                  >
                  <span class="meta-value"
                    >${e.last_updated?Ol(e.last_updated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
              ...
              <div class="settings">
                ...
                ${e.input_method===So?this._numRow(dr("panels.zones.labels.precipitation-rate",o),Oo(this.config,jo),e.precipitation_rate,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[jo]:parseFloat(a)}))),.1):q`
                      ${this._numRow(dr("panels.zones.labels.size",o),Oo(this.config,ro),e.size,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ro]:parseFloat(a)}))),.1)}
                      ${this._numRow(dr("panels.zones.labels.throughput",o),Oo(this.config,oo),e.throughput,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[oo]:parseFloat(a)}))),.1)}
                    `}
                ${this._numRow(dr("panels.zones.labels.drainage_rate",o),Oo(this.config,yo),e.drainage_rate,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[yo]:parseFloat(a)}))),.1)}
                ...
                ${this._numRow(dr("panels.zones.labels.bucket",o),Oo(this.config,mo),Number(e.bucket).toFixed(1),(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[mo]:parseFloat(a)}))),.1)}
                ${this._numRow(dr("panels.zones.labels.maximum-bucket",o),Oo(this.config,mo),Number(e.maximum_bucket).toFixed(1),(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[bo]:parseFloat(a)}))),.1)}
                ${this._numRow(dr("panels.zones.labels.irrigation-threshold",o),Oo(this.config,mo),Number(null!==(n=e.irrigation_threshold)&&void 0!==n?n:0).toFixed(1),(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ko]:parseFloat(a)}))),.1)}
                ${this._numRow(dr("panels.zones.labels.et-deficiency",o),Oo(this.config,mo),null!=e.et_deficiency?Number(e.et_deficiency).toFixed(2):"",(()=>{}),.01,!0)}
        ...
        <div class="card-content">
          ...
          <div class="setting-row">
            <div class="setting-label">
              ...
              <span class="unit">(${Oo(this.config,ro)})</span>
            </div>
            <input
              id="sizeInput"
              class="field"
        ...
        ${0===t.length?q`
            ...
            `:q`
              <div class="weather-table">
                ...
                ${t.slice(0,10).map((e=>{let t="-",a="-";try{if(e.timestamp&&null!==e.timestamp){const a=Ol(e.timestamp);a.isValid()&&(t=a.format("MM-DD HH:mm"))}}catch(t){console.warn("Error formatting timestamp:",e.timestamp,t)}try{if(e.retrieval_time&&null!==e.retrieval_time){const t=Ol(e.retrieval_time);t.isValid()&&(a=t.format("MM-DD HH:mm"))}}catch(t){console.warn("Error formatting retrieval_time:",e.retrieval_time,t)}return q`
                    <div class="weather-row">
                      <span>${t}</span>
                      <span
                        >${null!==e.temperature&&void 0!==e.temperature?e.temperature.toFixed(1)+"°C":"-"}</span
        ...
        <div class="card-content">
          <div class="card-content">
            ...
            <div class="setting-row">
              ...
              <select
                @change=${a=>{const i=a.target.value;this.handleEditMapping(t,Object.assign(Object.assign({},e),{[Mr]:""===i?void 0:parseInt(i)}))}}
              >
                <option
                  value=""
            ...
            ${Object.entries(e.mappings).filter((([t])=>!e.greenhouse||t!==Dr&&t!==Er)).filter((([t])=>{const a=this.consumedSources(e);return null===a||a.includes(t)})).map((([e])=>this.renderMappingSetting(t,e)))}
    ...
    `}_formatTime(e){if(!e.retrieved)return"-";const t=Ol(e.retrieved);return t.isValid()?t.format("YYYY-MM-DD HH:mm"):"-"}_formatValue(e,t){var a,i;return null==t||isNaN(t)?"-":t.toFixed(null!==(i=null===(a=Cl[e])||void 0===a?void 0:a.decimals)&&void 0!==i?i:1)}static get styles(){return l`
      ${ul} ${gl}
    ...
    `}};a([me()],Il.prototype,"narrow",void 0),a([me()],Il.prototype,"path",void 0),a([ge()],Il.prototype,"_info",void 0),a([ge()],Il.prototype,"_use",void 0),a([ge()],Il.prototype,"_service",void 0),a([ge()],Il.prototype,"_apiKey",void 0),a([ge()],Il.prototype,"_loading",void 0),a([ge()],Il.prototype,"_saving",void 0),a([ge()],Il.prototype,"_error",void 0),a([ge()],Il.prototype,"_saved",void 0),a([ge()],Il.prototype,"_history",void 0),a([ge()],Il.prototype,"_historyLoading",void 0),a([ge()],Il.prototype,"_historyError",void 0),Il=a([ce("smart-irrigation-view-weatherservice")],Il);const Ll=10,Bl=8,ql=26,Vl=46;let Rl=class extends(Jo(de)){constructor(){super(...arguments),this._records=[],this._loading=!0,this._error=""}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial history:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to refresh history:",e)}))}),{type:mr+"_config_updated"})]}async _fetchData(){if(this.hass)try{const[e,t]=await Promise.all([Bo(this.hass),Ko(this.hass,500)]);this._config=e,this._records=(null==t?void 0:t.records)||[],this._error=""}catch(e){this._error=(null==e?void 0:e.message)||(null==e?void 0:e.code)||String(e)}finally{this._loading=!1}}_chartDays(){const e=Ol().startOf("day").subtract(29,"days"),t=[];for(let a=0;a<30;a++)t.push(e.clone().add(a,"days").format("YYYY-MM-DD"));return t}_daily(e,t){const a=new Map(e.map((e=>[e,0])));for(const e of this._records){if(!e.start||t&&!t(e))continue;const i=Ol(e.start);if(!i.isValid())continue;const n=i.format("YYYY-MM-DD");a.has(n)&&a.set(n,a.get(n)+Po(e.water_used,this._config))}return e.map((e=>({key:e,value:a.get(e)})))}_chartedZones(e){const t=e[0],a=new Map;for(const e of this._records){if(!e.start)continue;const i=Ol(e.start);if(!i.isValid()||i.format("YYYY-MM-DD")<t)continue;const n=null!==e.zone_id?`#${e.zone_id}`:e.zone_name||"?";a.has(n)||a.set(n,{id:e.zone_id,name:e.zone_name||n})}return[...a.values()].sort(((e,t)=>e.name.localeCompare(t.name)))}render(){if(!this.hass)return q``;const e=this.hass.language;if(this._loading)return q`
    ...
    `}_renderTable(e){const t=this._records.slice(0,100),a=Oo(this._config,co);return q`
    ...
    `}_renderChart(e,t){const a=Oo(this._config,co),i=Math.max(...e.map((e=>e.value)),0);if(i<=0)return q`<div class="history-note">
        ${dr("panels.history.charts.no-data",t)}
      </div>`;const n=this._niceMax(i),s=200-Ll-ql,r=Ll+s,o=(720-Vl-Bl)/e.length,l=Math.max(o-3,1),d=[0,.5,1].map((e=>{const t=r-e*s;return V`
        <line
          class="grid"
          x1=${Vl}
          y1=${t}
      ...
      `})),u=e.map(((e,t)=>{const a=e.value/n*s;return V`
        ...
        >
          <title>
            ${Ol(e.key).format("LL")}: ${e.value.toFixed(1)}
          </title>
        </rect>
    ...
    `}_niceMax(e){const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}_formatAxis(e){return e>=100?e.toFixed(0):e.toFixed(1)}_formatStart(e){if(!e)return"-";const t=Ol(e);return t.isValid()?t.format("YYYY-MM-DD HH:mm"):"-"}static get styles(){return l`
      ${ul} ${gl}
        ...
        <div class="card-content">
          ${(null==a?void 0:a.next_irrigation_start)?q`
                <div class="info-item">
                  ...
                  <span class="value"
                    >${Ol(a.next_irrigation_start).format("ddd D MMM, HH:mm")}</span
                  >
                </div>
                <div class="info-item">
    ...
    `}renderCheckNumbers(e){var t,a,i,n,s,r;return"precipitation"===e.id?q`
      ...
      <div class="last-decision">
        ...
        ${t?q`<span class="value"
              >${t.should_skip?this.t("cards.decision.last-skipped"):this.t("cards.decision.last-ran")}${t.evaluated_at?` (${Ol(t.evaluated_at).format("ddd D MMM, HH:mm")})`:""}</span
            >`:q`<span class="value"
              >${this.t("cards.decision.last-none")}</span
            >`}
      </div>
    `}renderEstimates(){var e,t;const a=null!==(t=null===(e=this.info)||void 0===e?void 0:e.zone_estimates)&&void 0!==t?t:{},i=this.config?Oo(this.config,mo):"mm",n=this.zones.filter((e=>a[String(e.id)]));return q`
    ...
    `}};a([me()],Fl.prototype,"config",void 0),a([me({type:Object})],Fl.prototype,"info",void 0),a([me({type:Array})],Fl.prototype,"zones",void 0),a([me({type:Boolean})],Fl.prototype,"isLoading",void 0),Fl=a([ce("smart-irrigation-view-info")],Fl);const Wl=[Nr,xr,jr,Tr,Pr,Or,Sr,Dr,Er],Yl={sensors:"PyETO",et:"Passthrough",static:"Static"};let Zl=class extends de{constructor(){super(...arguments),this.step=0,this.allModules=[],this.modules=[],this.isSaving=!1,this.done=!1,this.zoneName="",this.zoneSize="",this.zoneThroughput="",this.underGlass=!1,this.weather="service",this.sensors={},this.staticDelta="",this.serviceSuppliesEt=!1}firstUpdated(){ke().catch((()=>{})),this._load().catch((e=>console.error("Setup wizard: load failed",e)))}async _load(){if(!this.hass)return;const[e,t,a,i]=await Promise.all([Bo(this.hass),Fo(this.hass),Uo(this.hass),qo(this.hass).catch((()=>{}))]);this.config=e,this.allModules=t,this.modules=a,this.serviceSuppliesEt=!!(null==i?void 0:i.supplies_evapotranspiration),this.usesWeatherService||(this.weather="sensors")}get lng(){var e,t;return null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en"}t(e){return dr(`panels.setup.${e}`,this.lng)}get usesWeatherService(){var e;return!!(null===(e=this.config)||void 0===e?void 0:e.use_weather_service)}get engineName(){return"service"===this.weather?this.serviceSuppliesEt?"Passthrough":"PyETO":Yl[this.weather]}get sourcesToAsk(){var e;const t=this.allModules.find((e=>e.name===this.engineName)),a=null!==(e=null==t?void 0:t.consumes)&&void 0!==e?e:Wl;return Wl.filter((e=>a.includes(e)&&!(this.underGlass&&(e===Dr||e===Er))))}get sensorsToAsk(){return"static"===this.weather?[]:"et"===this.weather?[Sr]:"sensors"===this.weather?this.sourcesToAsk:[]}get steps(){const e=["zone","environment","weather"];return(this.sensorsToAsk.length||"static"===this.weather)&&e.push("sensors"),e.push("review"),e}get currentStep(){return this.steps[Math.min(this.step,this.steps.length-1)]}get canGoOn(){switch(this.currentStep){case"zone":return""!==this.zoneName.trim()&&Number(this.zoneSize)>0&&Number(this.zoneThroughput)>0;case"sensors":return"static"===this.weather?Number(this.staticDelta)>0:this.sensorsToAsk.every((e=>{var t;return""!==(null!==(t=this.sensors[e])&&void 0!==t?t:"")}));default:return!0}}render(){return this.hass?this.done?q`
        <ha-card header="${this.t("title")}">
          <div class="card-content">
    ...
    `}sourceFor(e){return this.sensors[e]?{[Wr]:Lr,[Yr]:this.sensors[e],[Kr]:""}:"service"===this.weather&&this.sourcesToAsk.includes(e)?{[Wr]:Ir,[Yr]:"",[Kr]:""}:!this.underGlass||e!==Dr&&e!==Er?{[Wr]:Fr,[Yr]:"",[Kr]:""}:{[Wr]:Br,[Yr]:"",[Kr]:"",[Zr]:0}}async create(){if(this.hass&&!this.isSaving){this.isSaving=!0,this.error=void 0;try{let e=this.modules.find((e=>e.name===this.engineName));if(!e){const t=this.allModules.find((e=>e.name===this.engineName));if(!t)throw new Error(`Unknown calculation engine ${this.engineName}`);const a="static"===this.weather?Object.assign(Object.assign({},t.config),{delta:Number(this.staticDelta)}):t.config;await Wo(this.hass,{name:t.name,description:t.description,config:a,schema:t.schema});const i=await Uo(this.hass);this.modules=i,e=i.find((e=>e.name===this.engineName))}const t={name:this.zoneName.trim(),mappings:Object.fromEntries(Wl.map((e=>[e,this.sourceFor(e)]))),greenhouse:this.underGlass,[Mr]:null==e?void 0:e.id};await Zo(this.hass,t);const a=(await Yo(this.hass)).find((e=>e.name===t.name));await Ro(this.hass,{name:this.zoneName.trim(),size:Number(this.zoneSize),throughput:Number(this.zoneThroughput),state:"automatic",[ho]:null==a?void 0:a.id}),await Vo(this.hass),this.done=!0}catch(e){console.error("Setup wizard: could not create the zone",e),this.error=this.t("failed")}finally{this.isSaving=!1}}}static get styles(){return l`
      ${ul} ${gl}
